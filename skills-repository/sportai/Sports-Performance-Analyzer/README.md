...
**Sports Performance Analyzer** is a production-ready agent skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sportai/Sports-Performance-Analyzer

# Or install via pip
pip install skillshub-sports-performance-analyzer

# Or install via npm
npm install @skillshub/sports-performance-analyzer
```
...
skill = load_skill("sportai/Sports-Performance-Analyzer")
...
```json
{
  "skill": "sportai/Sports-Performance-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sportai/Sports-Performance-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sportai/Sports-Performance-Analyzer"),
...
```bash
# Clone the skill
skillshub clone sportai/Sports-Performance-Analyzer
...
**Built with ❤️ by [sportai](https://skillshub.dev/sportai) on [SkillsHub](https://skillshub.dev)**
