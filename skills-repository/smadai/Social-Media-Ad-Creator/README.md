...
> Creates social media ad copy and creative briefs for Facebook, Instagram, LinkedIn, and TikTok

## Overview

**Social Media Ad Creator** is a production-ready prompt skill designed for Marketing & SEO workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install smadai/Social-Media-Ad-Creator

# Or add to your agent configuration
skillshub agent add-skill smadai/Social-Media-Ad-Creator
```
...
skill = load_skill("smadai/Social-Media-Ad-Creator")
...
```json
{
  "skill": "smadai/Social-Media-Ad-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("smadai/Social-Media-Ad-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("smadai/Social-Media-Ad-Creator"),
...
```bash
# Clone the skill
skillshub clone smadai/Social-Media-Ad-Creator
cd Social-Media-Ad-Creator
...
**Built with ❤️ by [smadai](https://skillshub.dev/smadai) on [SkillsHub](https://skillshub.dev)**
