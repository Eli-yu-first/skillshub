...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-General-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Checks drug interactions with severity ratings, mechanism explanations, and alternative suggestions

## Overview

**Drug Interaction Checker** is a production-ready tool skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install drugai/Drug-Interaction-Checker

# Or install via pip
pip install skillshub-drug-interaction-checker

# Or install via npm
npm install @skillshub/drug-interaction-checker
```
...
skill = load_skill("drugai/Drug-Interaction-Checker")
...
```json
{
  "skill": "drugai/Drug-Interaction-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("drugai/Drug-Interaction-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("drugai/Drug-Interaction-Checker"),
...
```bash
# Clone the skill
skillshub clone drugai/Drug-Interaction-Checker
...
**Built with ❤️ by [drugai](https://skillshub.dev/drugai) on [SkillsHub](https://skillshub.dev)**
