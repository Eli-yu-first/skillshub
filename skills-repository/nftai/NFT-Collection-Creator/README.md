...
**NFT Collection Creator** is a production-ready workflow skill designed for Blockchain & Web3 workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install nftai/NFT-Collection-Creator

# Or install via pip
pip install skillshub-nft-collection-creator

# Or install via npm
npm install @skillshub/nft-collection-creator
```
...
skill = load_skill("nftai/NFT-Collection-Creator")
...
```json
{
  "skill": "nftai/NFT-Collection-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("nftai/NFT-Collection-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("nftai/NFT-Collection-Creator"),
...
```bash
# Clone the skill
skillshub clone nftai/NFT-Collection-Creator
...
**Built with ❤️ by [nftai](https://skillshub.dev/nftai) on [SkillsHub](https://skillshub.dev)**
