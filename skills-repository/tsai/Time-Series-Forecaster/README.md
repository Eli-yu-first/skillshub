...
**Time Series Forecaster** is a production-ready agent skill designed for Data Science workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tsai/Time-Series-Forecaster

# Or install via pip
pip install skillshub-time-series-forecaster

# Or install via npm
npm install @skillshub/time-series-forecaster
```
...
skill = load_skill("tsai/Time-Series-Forecaster")
...
```json
{
  "skill": "tsai/Time-Series-Forecaster",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tsai/Time-Series-Forecaster", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tsai/Time-Series-Forecaster"),
...
```bash
# Clone the skill
skillshub clone tsai/Time-Series-Forecaster
...
**Built with ❤️ by [tsai](https://skillshub.dev/tsai) on [SkillsHub](https://skillshub.dev)**
