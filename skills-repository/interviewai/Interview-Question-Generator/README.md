...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Human%20Resources-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Generates behavioral and technical interview questions with evaluation rubrics and follow-up prompts

## Overview

**Interview Question Generator** is a production-ready tool skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install interviewai/Interview-Question-Generator

# Or install via pip
pip install skillshub-interview-question-generator

# Or install via npm
npm install @skillshub/interview-question-generator
```
...
skill = load_skill("interviewai/Interview-Question-Generator")
...
```json
{
  "skill": "interviewai/Interview-Question-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("interviewai/Interview-Question-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("interviewai/Interview-Question-Generator"),
...
```bash
# Clone the skill
skillshub clone interviewai/Interview-Question-Generator
...
**Built with ❤️ by [interviewai](https://skillshub.dev/interviewai) on [SkillsHub](https://skillshub.dev)**
