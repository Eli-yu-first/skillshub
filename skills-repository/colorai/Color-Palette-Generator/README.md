...
**Color Palette Generator** is a production-ready tool skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install colorai/Color-Palette-Generator
...
skill = load_skill("colorai/Color-Palette-Generator")
...
```json
{
  "skill": "colorai/Color-Palette-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("colorai/Color-Palette-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("colorai/Color-Palette-Generator"),
...
```bash
# Clone the skill
skillshub clone colorai/Color-Palette-Generator
