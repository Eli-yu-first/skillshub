...
> Recommends restaurants based on cuisine, dietary needs, ambiance, and location with reservation assistance

## Overview

**Restaurant Recommendation** is a production-ready agent skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install dineai/Restaurant-Recommendation

# Or install via pip
pip install skillshub-restaurant-recommendation

# Or install via npm
npm install @skillshub/restaurant-recommendation
```
...
skill = load_skill("dineai/Restaurant-Recommendation")
...
```json
{
  "skill": "dineai/Restaurant-Recommendation",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("dineai/Restaurant-Recommendation", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("dineai/Restaurant-Recommendation"),
...
```bash
# Clone the skill
skillshub clone dineai/Restaurant-Recommendation
...
**Built with ❤️ by [dineai](https://skillshub.dev/dineai) on [SkillsHub](https://skillshub.dev)**
