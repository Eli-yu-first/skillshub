...
**Multimedia Story Planner** is a production-ready workflow skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install multi-media/Multimedia-Story-Planner

# Or install via pip
pip install skillshub-multimedia-story-planner

# Or install via npm
npm install @skillshub/multimedia-story-planner
```
...
skill = load_skill("multi-media/Multimedia-Story-Planner")
...
```json
{
  "skill": "multi-media/Multimedia-Story-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("multi-media/Multimedia-Story-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("multi-media/Multimedia-Story-Planner"),
...
```bash
# Clone the skill
skillshub clone multi-media/Multimedia-Story-Planner
cd Multimedia-Story-Planner
...
**Built with ❤️ by [multi-media](https://skillshub.dev/multi-media) on [SkillsHub](https://skillshub.dev)**
