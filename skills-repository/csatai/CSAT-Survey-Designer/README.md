...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Customer%20Service-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Designs customer satisfaction surveys with NPS, CSAT, and CES metrics and analysis frameworks

## Overview

**CSAT Survey Designer** is a production-ready tool skill designed for Customer Service workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install csatai/CSAT-Survey-Designer

# Or install via pip
pip install skillshub-csat-survey-designer

# Or install via npm
npm install @skillshub/csat-survey-designer
```
...
skill = load_skill("csatai/CSAT-Survey-Designer")
...
```json
{
  "skill": "csatai/CSAT-Survey-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("csatai/CSAT-Survey-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("csatai/CSAT-Survey-Designer"),
...
```bash
# Clone the skill
skillshub clone csatai/CSAT-Survey-Designer
cd CSAT-Survey-Designer
...
**Built with ❤️ by [csatai](https://skillshub.dev/csatai) on [SkillsHub](https://skillshub.dev)**
