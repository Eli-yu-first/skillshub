...
> Optimize headlines for engagement while maintaining journalistic integrity and accuracy

## Overview

**Headline Optimizer** is a production-ready prompt skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install headline-ai/Headline-Optimizer

# Or add to your agent configuration
skillshub agent add-skill headline-ai/Headline-Optimizer
```
...
skill = load_skill("headline-ai/Headline-Optimizer")
...
```json
{
  "skill": "headline-ai/Headline-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("headline-ai/Headline-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("headline-ai/Headline-Optimizer"),
...
```bash
# Clone the skill
skillshub clone headline-ai/Headline-Optimizer
cd Headline-Optimizer
...
**Built with ❤️ by [headline-ai](https://skillshub.dev/headline-ai) on [SkillsHub](https://skillshub.dev)**
