...
> Assist in photo culling by analyzing sharpness, exposure, and composition quality

## Overview

**Image Culling Assistant** is a production-ready agent skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install cull-ai/Image-Culling-Assistant

# Or install via pip
pip install skillshub-image-culling-assistant

# Or install via npm
npm install @skillshub/image-culling-assistant
```
...
skill = load_skill("cull-ai/Image-Culling-Assistant")
...
```json
{
  "skill": "cull-ai/Image-Culling-Assistant",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("cull-ai/Image-Culling-Assistant", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("cull-ai/Image-Culling-Assistant"),
...
```bash
# Clone the skill
skillshub clone cull-ai/Image-Culling-Assistant
cd Image-Culling-Assistant
...
**Built with ❤️ by [cull-ai](https://skillshub.dev/cull-ai) on [SkillsHub](https://skillshub.dev)**
