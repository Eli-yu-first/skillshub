...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Non-profit%20%26%20Social%20Impact-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Plan fundraising campaigns with goal setting, channel strategy, and donor segmentation

## Overview

**Fundraising Campaign Planner** is a production-ready workflow skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install fund-plan/Fundraising-Campaign-Planner

# Or install via pip
pip install skillshub-fundraising-campaign-planner

# Or install via npm
npm install @skillshub/fundraising-campaign-planner
```
...
skill = load_skill("fund-plan/Fundraising-Campaign-Planner")
...
```json
{
  "skill": "fund-plan/Fundraising-Campaign-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("fund-plan/Fundraising-Campaign-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("fund-plan/Fundraising-Campaign-Planner"),
...
```bash
# Clone the skill
skillshub clone fund-plan/Fundraising-Campaign-Planner
cd Fundraising-Campaign-Planner
...
**Built with ❤️ by [fund-plan](https://skillshub.dev/fund-plan) on [SkillsHub](https://skillshub.dev)**
