...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Non-profit%20%26%20Social%20Impact-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Write compelling grant proposals with needs assessment, methodology, and budget justification

## Overview

**Grant Proposal Writer Pro** is a production-ready prompt skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install grant-ai/Grant-Proposal-Writer-Pro

# Or add to your agent configuration
skillshub agent add-skill grant-ai/Grant-Proposal-Writer-Pro
```
...
skill = load_skill("grant-ai/Grant-Proposal-Writer-Pro")
...
```json
{
  "skill": "grant-ai/Grant-Proposal-Writer-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("grant-ai/Grant-Proposal-Writer-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("grant-ai/Grant-Proposal-Writer-Pro"),
...
```bash
# Clone the skill
skillshub clone grant-ai/Grant-Proposal-Writer-Pro
cd Grant-Proposal-Writer-Pro
...
**Built with ❤️ by [grant-ai](https://skillshub.dev/grant-ai) on [SkillsHub](https://skillshub.dev)**
