...
> Generates realistic product mockups for packaging, devices, apparel, and marketing materials

## Overview

**Product Mockup Creator** is a production-ready tool skill designed for Image Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mockupai/Product-Mockup-Creator

# Or install via pip
pip install skillshub-product-mockup-creator

# Or install via npm
npm install @skillshub/product-mockup-creator
```
...
skill = load_skill("mockupai/Product-Mockup-Creator")
...
```json
{
  "skill": "mockupai/Product-Mockup-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mockupai/Product-Mockup-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mockupai/Product-Mockup-Creator"),
...
```bash
# Clone the skill
skillshub clone mockupai/Product-Mockup-Creator
cd Product-Mockup-Creator
...
**Built with ❤️ by [mockupai](https://skillshub.dev/mockupai) on [SkillsHub](https://skillshub.dev)**
