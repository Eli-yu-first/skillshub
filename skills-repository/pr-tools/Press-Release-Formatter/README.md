...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Journalism%20%26%20Media-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Format press releases with proper structure, boilerplate, and media contact sections

## Overview

**Press Release Formatter** is a production-ready template skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pr-tools/Press-Release-Formatter

# Or install via pip
pip install skillshub-press-release-formatter

# Or install via npm
npm install @skillshub/press-release-formatter
```
...
skill = load_skill("pr-tools/Press-Release-Formatter")
...
```json
{
  "skill": "pr-tools/Press-Release-Formatter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pr-tools/Press-Release-Formatter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pr-tools/Press-Release-Formatter"),
...
```bash
# Clone the skill
skillshub clone pr-tools/Press-Release-Formatter
cd Press-Release-Formatter
...
**Built with ❤️ by [pr-tools](https://skillshub.dev/pr-tools) on [SkillsHub](https://skillshub.dev)**
