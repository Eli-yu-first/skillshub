...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Music%20Production-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Produces podcasts with script writing, audio editing guidance, show notes generation, and RSS feed setup

## Overview

**Podcast Production Suite** is a production-ready workflow skill designed for Music Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install podcastai/Podcast-Production-Suite

# Or install via pip
pip install skillshub-podcast-production-suite

# Or install via npm
npm install @skillshub/podcast-production-suite
```
...
skill = load_skill("podcastai/Podcast-Production-Suite")
...
```json
{
  "skill": "podcastai/Podcast-Production-Suite",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("podcastai/Podcast-Production-Suite", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("podcastai/Podcast-Production-Suite"),
...
```bash
# Clone the skill
skillshub clone podcastai/Podcast-Production-Suite
cd Podcast-Production-Suite
...
**Built with ❤️ by [podcastai](https://skillshub.dev/podcastai) on [SkillsHub](https://skillshub.dev)**
