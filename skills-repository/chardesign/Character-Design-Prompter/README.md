...
**Character Design Prompter** is a production-ready prompt skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install chardesign/Character-Design-Prompter

# Or add to your agent configuration
skillshub agent add-skill chardesign/Character-Design-Prompter
```
...
skill = load_skill("chardesign/Character-Design-Prompter")
...
```json
{
  "skill": "chardesign/Character-Design-Prompter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("chardesign/Character-Design-Prompter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("chardesign/Character-Design-Prompter"),
...
```bash
# Clone the skill
skillshub clone chardesign/Character-Design-Prompter
cd Character-Design-Prompter
...
**Built with ❤️ by [chardesign](https://skillshub.dev/chardesign) on [SkillsHub](https://skillshub.dev)**
