...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Human%20Resources-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Creates employee onboarding workflows with document collection, training schedules, and buddy assignment

## Overview

**Employee Onboarding Flow** is a production-ready workflow skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install onboardhr/Employee-Onboarding-Flow

# Or install via pip
pip install skillshub-employee-onboarding-flow

# Or install via npm
npm install @skillshub/employee-onboarding-flow
```
...
skill = load_skill("onboardhr/Employee-Onboarding-Flow")
...
```json
{
  "skill": "onboardhr/Employee-Onboarding-Flow",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("onboardhr/Employee-Onboarding-Flow", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("onboardhr/Employee-Onboarding-Flow"),
...
```bash
# Clone the skill
skillshub clone onboardhr/Employee-Onboarding-Flow
cd Employee-Onboarding-Flow
...
**Built with ❤️ by [onboardhr](https://skillshub.dev/onboardhr) on [SkillsHub](https://skillshub.dev)**
