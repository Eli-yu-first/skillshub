...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Animation%20Production-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Provides step-by-step rigging setup guides for 2D and 3D character animation in Blender/Maya/Spine

## Overview

**Rigging Setup Guide** is a production-ready workflow skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install rigbot/Rigging-Setup-Guide

# Or install via pip
pip install skillshub-rigging-setup-guide

# Or install via npm
npm install @skillshub/rigging-setup-guide
```
...
skill = load_skill("rigbot/Rigging-Setup-Guide")
...
```json
{
  "skill": "rigbot/Rigging-Setup-Guide",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("rigbot/Rigging-Setup-Guide", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("rigbot/Rigging-Setup-Guide"),
...
```bash
# Clone the skill
skillshub clone rigbot/Rigging-Setup-Guide
cd Rigging-Setup-Guide
...
**Built with ❤️ by [rigbot](https://skillshub.dev/rigbot) on [SkillsHub](https://skillshub.dev)**
