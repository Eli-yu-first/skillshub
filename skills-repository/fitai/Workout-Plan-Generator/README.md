...
**Workout Plan Generator** is a production-ready tool skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install fitai/Workout-Plan-Generator

# Or install via pip
pip install skillshub-workout-plan-generator

# Or install via npm
npm install @skillshub/workout-plan-generator
```
...
skill = load_skill("fitai/Workout-Plan-Generator")
...
```json
{
  "skill": "fitai/Workout-Plan-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("fitai/Workout-Plan-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("fitai/Workout-Plan-Generator"),
...
```bash
# Clone the skill
skillshub clone fitai/Workout-Plan-Generator
...
**Built with ❤️ by [fitai](https://skillshub.dev/fitai) on [SkillsHub](https://skillshub.dev)**
