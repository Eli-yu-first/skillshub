...
**Game Lore Generator** is a production-ready prompt skill designed for Game Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install worldbuilder-ai/Game-Lore-Generator

# Or add to your agent configuration
skillshub agent add-skill worldbuilder-ai/Game-Lore-Generator
```
...
skill = load_skill("worldbuilder-ai/Game-Lore-Generator")
...
```json
{
  "skill": "worldbuilder-ai/Game-Lore-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("worldbuilder-ai/Game-Lore-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("worldbuilder-ai/Game-Lore-Generator"),
...
```bash
# Clone the skill
skillshub clone worldbuilder-ai/Game-Lore-Generator
cd Game-Lore-Generator
...
**Built with ❤️ by [worldbuilder-ai](https://skillshub.dev/worldbuilder-ai) on [SkillsHub](https://skillshub.dev)**
