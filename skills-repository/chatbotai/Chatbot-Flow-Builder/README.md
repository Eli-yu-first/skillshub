...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Customer%20Service-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Designs conversational chatbot flows with intent recognition, entity extraction, and fallback handling

## Overview

**Chatbot Flow Builder** is a production-ready workflow skill designed for Customer Service workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install chatbotai/Chatbot-Flow-Builder

# Or install via pip
pip install skillshub-chatbot-flow-builder

# Or install via npm
npm install @skillshub/chatbot-flow-builder
```
...
skill = load_skill("chatbotai/Chatbot-Flow-Builder")
...
```json
{
  "skill": "chatbotai/Chatbot-Flow-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("chatbotai/Chatbot-Flow-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("chatbotai/Chatbot-Flow-Builder"),
...
```bash
# Clone the skill
skillshub clone chatbotai/Chatbot-Flow-Builder
...
**Built with ❤️ by [chatbotai](https://skillshub.dev/chatbotai) on [SkillsHub](https://skillshub.dev)**
