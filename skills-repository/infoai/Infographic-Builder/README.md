...
**Infographic Builder** is a production-ready agent skill designed for Image Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install infoai/Infographic-Builder

# Or install via pip
pip install skillshub-infographic-builder

# Or install via npm
npm install @skillshub/infographic-builder
```
...
skill = load_skill("infoai/Infographic-Builder")
...
```json
{
  "skill": "infoai/Infographic-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("infoai/Infographic-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("infoai/Infographic-Builder"),
...
```bash
# Clone the skill
skillshub clone infoai/Infographic-Builder
cd Infographic-Builder
...
**Built with ❤️ by [infoai](https://skillshub.dev/infoai) on [SkillsHub](https://skillshub.dev)**
