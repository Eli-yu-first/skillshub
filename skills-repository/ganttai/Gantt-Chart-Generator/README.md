...
**Gantt Chart Generator** is a production-ready tool skill designed for Project Management workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install ganttai/Gantt-Chart-Generator

# Or install via pip
pip install skillshub-gantt-chart-generator

# Or install via npm
npm install @skillshub/gantt-chart-generator
```
...
skill = load_skill("ganttai/Gantt-Chart-Generator")
...
```json
{
  "skill": "ganttai/Gantt-Chart-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("ganttai/Gantt-Chart-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("ganttai/Gantt-Chart-Generator"),
...
```bash
# Clone the skill
skillshub clone ganttai/Gantt-Chart-Generator
...
**Built with ❤️ by [ganttai](https://skillshub.dev/ganttai) on [SkillsHub](https://skillshub.dev)**
