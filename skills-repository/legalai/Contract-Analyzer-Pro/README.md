...
**Contract Analyzer Pro** is a production-ready agent skill designed for Legal Domain workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install legalai/Contract-Analyzer-Pro

# Or install via pip
pip install skillshub-contract-analyzer-pro

# Or install via npm
npm install @skillshub/contract-analyzer-pro
```
...
skill = load_skill("legalai/Contract-Analyzer-Pro")
...
```json
{
  "skill": "legalai/Contract-Analyzer-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("legalai/Contract-Analyzer-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("legalai/Contract-Analyzer-Pro"),
...
```bash
# Clone the skill
skillshub clone legalai/Contract-Analyzer-Pro
...
**Built with ❤️ by [legalai](https://skillshub.dev/legalai) on [SkillsHub](https://skillshub.dev)**
