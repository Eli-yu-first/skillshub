...
**Clinical Note Generator** is a production-ready prompt skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install medtech-ai/Clinical-Note-Generator

# Or add to your agent configuration
skillshub agent add-skill medtech-ai/Clinical-Note-Generator
```
...
skill = load_skill("medtech-ai/Clinical-Note-Generator")
...
```json
{
  "skill": "medtech-ai/Clinical-Note-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("medtech-ai/Clinical-Note-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("medtech-ai/Clinical-Note-Generator"),
...
```bash
# Clone the skill
skillshub clone medtech-ai/Clinical-Note-Generator
...
**Built with ❤️ by [medtech-ai](https://skillshub.dev/medtech-ai) on [SkillsHub](https://skillshub.dev)**
