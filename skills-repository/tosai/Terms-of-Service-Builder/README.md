...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Legal%20Domain-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Builds comprehensive Terms of Service documents with liability limitations and dispute resolution clauses

## Overview

**Terms of Service Builder** is a production-ready template skill designed for Legal Domain workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tosai/Terms-of-Service-Builder

# Or install via pip
pip install skillshub-terms-of-service-builder

# Or install via npm
npm install @skillshub/terms-of-service-builder
```
...
skill = load_skill("tosai/Terms-of-Service-Builder")
...
```json
{
  "skill": "tosai/Terms-of-Service-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tosai/Terms-of-Service-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tosai/Terms-of-Service-Builder"),
...
```bash
# Clone the skill
skillshub clone tosai/Terms-of-Service-Builder
cd Terms-of-Service-Builder
...
**Built with ❤️ by [tosai](https://skillshub.dev/tosai) on [SkillsHub](https://skillshub.dev)**
