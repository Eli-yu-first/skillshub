...
**AutoML Configurator** is a production-ready tool skill designed for Machine Learning workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install automlai/AutoML-Configurator

# Or install via pip
pip install skillshub-automl-configurator

# Or install via npm
npm install @skillshub/automl-configurator
```
...
skill = load_skill("automlai/AutoML-Configurator")
...
```json
{
  "skill": "automlai/AutoML-Configurator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("automlai/AutoML-Configurator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("automlai/AutoML-Configurator"),
...
```bash
# Clone the skill
skillshub clone automlai/AutoML-Configurator
cd AutoML-Configurator
...
**Built with ❤️ by [automlai](https://skillshub.dev/automlai) on [SkillsHub](https://skillshub.dev)**
