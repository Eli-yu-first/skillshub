...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Content%20Creation-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Design and write email newsletters with personalization tokens and A/B test variants

## Overview

**Newsletter Composer** is a production-ready template skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mail-craft/Newsletter-Composer

# Or install via pip
pip install skillshub-newsletter-composer

# Or install via npm
npm install @skillshub/newsletter-composer
```
...
skill = load_skill("mail-craft/Newsletter-Composer")
...
```json
{
  "skill": "mail-craft/Newsletter-Composer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mail-craft/Newsletter-Composer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mail-craft/Newsletter-Composer"),
...
```bash
# Clone the skill
skillshub clone mail-craft/Newsletter-Composer
...
**Built with ❤️ by [mail-craft](https://skillshub.dev/mail-craft) on [SkillsHub](https://skillshub.dev)**
