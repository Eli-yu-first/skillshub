...
> Transform long-form content into multiple formats: threads, shorts, carousels, and summaries

## Overview

**Content Repurposing Agent** is a production-ready agent skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install repurpose-ai/Content-Repurposing-Agent

# Or install via pip
pip install skillshub-content-repurposing-agent

# Or install via npm
npm install @skillshub/content-repurposing-agent
```
...
skill = load_skill("repurpose-ai/Content-Repurposing-Agent")
...
```json
{
  "skill": "repurpose-ai/Content-Repurposing-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("repurpose-ai/Content-Repurposing-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("repurpose-ai/Content-Repurposing-Agent"),
...
```bash
# Clone the skill
skillshub clone repurpose-ai/Content-Repurposing-Agent
...
**Built with ❤️ by [repurpose-ai](https://skillshub.dev/repurpose-ai) on [SkillsHub](https://skillshub.dev)**
