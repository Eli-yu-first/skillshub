# Supplement Guide Agent

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Fitness%20%26%20Sports-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Guides supplement selection with evidence-based recommendations, dosage protocols, and interaction warnings

## Overview

**Supplement Guide Agent** is a production-ready agent skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install suppai/Supplement-Guide-Agent

# Or install via pip
pip install skillshub-supplement-guide-agent

# Or install via npm
npm install @skillshub/supplement-guide-agent
```
...
skill = load_skill("suppai/Supplement-Guide-Agent")
...
```json
{
  "skill": "suppai/Supplement-Guide-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("suppai/Supplement-Guide-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("suppai/Supplement-Guide-Agent"),
...
```bash
# Clone the skill
skillshub clone suppai/Supplement-Guide-Agent
cd Supplement-Guide-Agent
...
**Built with ❤️ by [suppai](https://skillshub.dev/suppai) on [SkillsHub](https://skillshub.dev)**
