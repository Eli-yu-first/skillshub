...
**ML Experiment Tracker** is a production-ready tool skill designed for Machine Learning workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install exptrackr/ML-Experiment-Tracker

# Or install via pip
pip install skillshub-ml-experiment-tracker

# Or install via npm
npm install @skillshub/ml-experiment-tracker
```
...
skill = load_skill("exptrackr/ML-Experiment-Tracker")
...
```json
{
  "skill": "exptrackr/ML-Experiment-Tracker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("exptrackr/ML-Experiment-Tracker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("exptrackr/ML-Experiment-Tracker"),
...
```bash
# Clone the skill
skillshub clone exptrackr/ML-Experiment-Tracker
...
**Built with ❤️ by [exptrackr](https://skillshub.dev/exptrackr) on [SkillsHub](https://skillshub.dev)**
