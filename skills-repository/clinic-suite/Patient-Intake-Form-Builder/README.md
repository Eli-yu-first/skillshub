...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Healthcare%20%26%20Medical-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generate customizable patient intake forms with smart field validation and EHR integration

## Overview

**Patient Intake Form Builder** is a production-ready template skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install clinic-suite/Patient-Intake-Form-Builder

# Or install via pip
pip install skillshub-patient-intake-form-builder

# Or install via npm
npm install @skillshub/patient-intake-form-builder
```
...
skill = load_skill("clinic-suite/Patient-Intake-Form-Builder")
...
```json
{
  "skill": "clinic-suite/Patient-Intake-Form-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("clinic-suite/Patient-Intake-Form-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("clinic-suite/Patient-Intake-Form-Builder"),
...
```bash
# Clone the skill
skillshub clone clinic-suite/Patient-Intake-Form-Builder
cd Patient-Intake-Form-Builder
...
**Built with ❤️ by [clinic-suite](https://skillshub.dev/clinic-suite) on [SkillsHub](https://skillshub.dev)**
