...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Journalism%20%26%20Media-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Evaluate source credibility based on track record, bias indicators, and expertise

## Overview

**Source Credibility Evaluator** is a production-ready agent skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install trust-media/Source-Credibility-Evaluator

# Or install via pip
pip install skillshub-source-credibility-evaluator

# Or install via npm
npm install @skillshub/source-credibility-evaluator
```
...
skill = load_skill("trust-media/Source-Credibility-Evaluator")
...
```json
{
  "skill": "trust-media/Source-Credibility-Evaluator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("trust-media/Source-Credibility-Evaluator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("trust-media/Source-Credibility-Evaluator"),
...
```bash
# Clone the skill
skillshub clone trust-media/Source-Credibility-Evaluator
cd Source-Credibility-Evaluator
...
**Built with ❤️ by [trust-media](https://skillshub.dev/trust-media) on [SkillsHub](https://skillshub.dev)**
