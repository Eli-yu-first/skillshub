...
> Recommends outfits based on occasion, weather, body type, and personal style preferences

## Overview

**Outfit Recommendation Engine** is a production-ready agent skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install outfitai/Outfit-Recommendation-Engine

# Or install via pip
pip install skillshub-outfit-recommendation-engine

# Or install via npm
npm install @skillshub/outfit-recommendation-engine
```
...
skill = load_skill("outfitai/Outfit-Recommendation-Engine")
...
```json
{
  "skill": "outfitai/Outfit-Recommendation-Engine",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("outfitai/Outfit-Recommendation-Engine", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("outfitai/Outfit-Recommendation-Engine"),
...
```bash
# Clone the skill
skillshub clone outfitai/Outfit-Recommendation-Engine
cd Outfit-Recommendation-Engine
...
**Built with ❤️ by [outfitai](https://skillshub.dev/outfitai) on [SkillsHub](https://skillshub.dev)**
