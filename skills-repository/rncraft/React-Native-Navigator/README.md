...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-App%20Development-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Sets up React Native navigation with stack, tab, and drawer navigators including deep linking

## Overview

**React Native Navigator** is a production-ready workflow skill designed for App Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install rncraft/React-Native-Navigator

# Or install via pip
pip install skillshub-react-native-navigator

# Or install via npm
npm install @skillshub/react-native-navigator
```
...
skill = load_skill("rncraft/React-Native-Navigator")
...
```json
{
  "skill": "rncraft/React-Native-Navigator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("rncraft/React-Native-Navigator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("rncraft/React-Native-Navigator"),
...
```bash
# Clone the skill
skillshub clone rncraft/React-Native-Navigator
cd React-Native-Navigator
...
**Built with ❤️ by [rncraft](https://skillshub.dev/rncraft) on [SkillsHub](https://skillshub.dev)**
