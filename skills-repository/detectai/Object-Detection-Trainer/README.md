...
**Object Detection Trainer** is a production-ready workflow skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install detectai/Object-Detection-Trainer

# Or install via pip
pip install skillshub-object-detection-trainer

# Or install via npm
npm install @skillshub/object-detection-trainer
```
...
skill = load_skill("detectai/Object-Detection-Trainer")
...
```json
{
  "skill": "detectai/Object-Detection-Trainer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("detectai/Object-Detection-Trainer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("detectai/Object-Detection-Trainer"),
...
```bash
# Clone the skill
skillshub clone detectai/Object-Detection-Trainer
cd Object-Detection-Trainer
...
**Built with ❤️ by [detectai](https://skillshub.dev/detectai) on [SkillsHub](https://skillshub.dev)**
