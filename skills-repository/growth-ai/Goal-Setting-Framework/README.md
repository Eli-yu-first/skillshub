...
> Create SMART goals with action plans, milestones, and accountability checkpoints

## Overview

**Goal Setting Framework** is a production-ready prompt skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install growth-ai/Goal-Setting-Framework

# Or add to your agent configuration
skillshub agent add-skill growth-ai/Goal-Setting-Framework
```
...
skill = load_skill("growth-ai/Goal-Setting-Framework")
...
```json
{
  "skill": "growth-ai/Goal-Setting-Framework",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("growth-ai/Goal-Setting-Framework", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("growth-ai/Goal-Setting-Framework"),
...
```bash
# Clone the skill
skillshub clone growth-ai/Goal-Setting-Framework
cd Goal-Setting-Framework
...
**Built with ❤️ by [growth-ai](https://skillshub.dev/growth-ai) on [SkillsHub](https://skillshub.dev)**
