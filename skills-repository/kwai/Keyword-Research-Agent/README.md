...
**Keyword Research Agent** is a production-ready agent skill designed for Marketing & SEO workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install kwai/Keyword-Research-Agent

# Or install via pip
pip install skillshub-keyword-research-agent

# Or install via npm
npm install @skillshub/keyword-research-agent
```
...
skill = load_skill("kwai/Keyword-Research-Agent")
...
```json
{
  "skill": "kwai/Keyword-Research-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("kwai/Keyword-Research-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("kwai/Keyword-Research-Agent"),
...
```bash
# Clone the skill
skillshub clone kwai/Keyword-Research-Agent
...
**Built with ❤️ by [kwai](https://skillshub.dev/kwai) on [SkillsHub](https://skillshub.dev)**
