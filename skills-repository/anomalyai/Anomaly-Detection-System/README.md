...
**Anomaly Detection System** is a production-ready agent skill designed for Data Science workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install anomalyai/Anomaly-Detection-System

# Or install via pip
pip install skillshub-anomaly-detection-system

# Or install via npm
npm install @skillshub/anomaly-detection-system
```
...
skill = load_skill("anomalyai/Anomaly-Detection-System")
...
```json
{
  "skill": "anomalyai/Anomaly-Detection-System",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("anomalyai/Anomaly-Detection-System", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("anomalyai/Anomaly-Detection-System"),
...
```bash
# Clone the skill
skillshub clone anomalyai/Anomaly-Detection-System
...
**Built with ❤️ by [anomalyai](https://skillshub.dev/anomalyai) on [SkillsHub](https://skillshub.dev)**
