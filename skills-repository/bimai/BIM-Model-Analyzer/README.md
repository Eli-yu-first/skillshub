...
**BIM Model Analyzer** is a production-ready tool skill designed for Architecture & Interior Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bimai/BIM-Model-Analyzer

# Or install via pip
pip install skillshub-bim-model-analyzer

# Or install via npm
npm install @skillshub/bim-model-analyzer
```
...
skill = load_skill("bimai/BIM-Model-Analyzer")
...
```json
{
  "skill": "bimai/BIM-Model-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bimai/BIM-Model-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bimai/BIM-Model-Analyzer"),
...
```bash
# Clone the skill
skillshub clone bimai/BIM-Model-Analyzer
...
**Built with ❤️ by [bimai](https://skillshub.dev/bimai) on [SkillsHub](https://skillshub.dev)**
