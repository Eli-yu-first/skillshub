...
**REST API Designer** is a production-ready agent skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install apiforge/REST-API-Designer

# Or install via pip
pip install skillshub-rest-api-designer

# Or install via npm
npm install @skillshub/rest-api-designer
```
...
skill = load_skill("apiforge/REST-API-Designer")
...
```json
{
  "skill": "apiforge/REST-API-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("apiforge/REST-API-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("apiforge/REST-API-Designer"),
...
```bash
# Clone the skill
skillshub clone apiforge/REST-API-Designer
cd REST-API-Designer
...
**Built with ❤️ by [apiforge](https://skillshub.dev/apiforge) on [SkillsHub](https://skillshub.dev)**
