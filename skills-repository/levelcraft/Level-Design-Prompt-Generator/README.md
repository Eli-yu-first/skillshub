# Level Design Prompt Generator

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Game%20Development-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generate detailed level design briefs with layout suggestions, difficulty curves, and pacing

## Overview

**Level Design Prompt Generator** is a production-ready prompt skill designed for Game Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install levelcraft/Level-Design-Prompt-Generator

# Or add to your agent configuration
skillshub agent add-skill levelcraft/Level-Design-Prompt-Generator
```
...
skill = load_skill("levelcraft/Level-Design-Prompt-Generator")
...
```json
{
  "skill": "levelcraft/Level-Design-Prompt-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("levelcraft/Level-Design-Prompt-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("levelcraft/Level-Design-Prompt-Generator"),
...
```bash
# Clone the skill
skillshub clone levelcraft/Level-Design-Prompt-Generator
cd Level-Design-Prompt-Generator
...
**Built with ❤️ by [levelcraft](https://skillshub.dev/levelcraft) on [SkillsHub](https://skillshub.dev)**
