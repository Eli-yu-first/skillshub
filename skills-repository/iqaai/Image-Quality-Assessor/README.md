...
> Assesses image quality with blur detection, noise estimation, and aesthetic scoring

## Overview

**Image Quality Assessor** is a production-ready tool skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install iqaai/Image-Quality-Assessor

# Or install via pip
pip install skillshub-image-quality-assessor

# Or install via npm
npm install @skillshub/image-quality-assessor
```
...
skill = load_skill("iqaai/Image-Quality-Assessor")
...
```json
{
  "skill": "iqaai/Image-Quality-Assessor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("iqaai/Image-Quality-Assessor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("iqaai/Image-Quality-Assessor"),
...
```bash
# Clone the skill
skillshub clone iqaai/Image-Quality-Assessor
cd Image-Quality-Assessor
...
**Built with ❤️ by [iqaai](https://skillshub.dev/iqaai) on [SkillsHub](https://skillshub.dev)**
