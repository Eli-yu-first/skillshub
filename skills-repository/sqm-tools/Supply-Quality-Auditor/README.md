...
> Audit incoming material quality with statistical sampling plans and acceptance criteria

## Overview

**Supply Quality Auditor** is a production-ready agent skill designed for Manufacturing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sqm-tools/Supply-Quality-Auditor

# Or install via pip
pip install skillshub-supply-quality-auditor

# Or install via npm
npm install @skillshub/supply-quality-auditor
```
...
skill = load_skill("sqm-tools/Supply-Quality-Auditor")
...
```json
{
  "skill": "sqm-tools/Supply-Quality-Auditor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sqm-tools/Supply-Quality-Auditor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sqm-tools/Supply-Quality-Auditor"),
...
```bash
# Clone the skill
skillshub clone sqm-tools/Supply-Quality-Auditor
cd Supply-Quality-Auditor
...
**Built with ❤️ by [sqm-tools](https://skillshub.dev/sqm-tools) on [SkillsHub](https://skillshub.dev)**
