...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Non-profit%20%26%20Social%20Impact-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generate impact reports with data visualization, beneficiary stories, and outcome metrics

## Overview

**Impact Report Generator** is a production-ready template skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install impact-ai/Impact-Report-Generator

# Or install via pip
pip install skillshub-impact-report-generator

# Or install via npm
npm install @skillshub/impact-report-generator
```
...
skill = load_skill("impact-ai/Impact-Report-Generator")
...
```json
{
  "skill": "impact-ai/Impact-Report-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("impact-ai/Impact-Report-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("impact-ai/Impact-Report-Generator"),
...
```bash
# Clone the skill
skillshub clone impact-ai/Impact-Report-Generator
cd Impact-Report-Generator
...
**Built with ❤️ by [impact-ai](https://skillshub.dev/impact-ai) on [SkillsHub](https://skillshub.dev)**
