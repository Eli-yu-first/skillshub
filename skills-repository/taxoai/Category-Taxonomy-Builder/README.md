...
**Category Taxonomy Builder** is a production-ready tool skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install taxoai/Category-Taxonomy-Builder

# Or install via pip
pip install skillshub-category-taxonomy-builder

# Or install via npm
npm install @skillshub/category-taxonomy-builder
```
...
skill = load_skill("taxoai/Category-Taxonomy-Builder")
...
```json
{
  "skill": "taxoai/Category-Taxonomy-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("taxoai/Category-Taxonomy-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("taxoai/Category-Taxonomy-Builder"),
...
```bash
# Clone the skill
skillshub clone taxoai/Category-Taxonomy-Builder
cd Category-Taxonomy-Builder
...
**Built with ❤️ by [taxoai](https://skillshub.dev/taxoai) on [SkillsHub](https://skillshub.dev)**
