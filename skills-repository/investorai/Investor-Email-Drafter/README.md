...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Entrepreneurship-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Crafts compelling cold emails to investors with personalization, traction highlights, and clear asks

## Overview

**Investor Email Drafter** is a production-ready prompt skill designed for Entrepreneurship workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install investorai/Investor-Email-Drafter

# Or add to your agent configuration
skillshub agent add-skill investorai/Investor-Email-Drafter
```
...
skill = load_skill("investorai/Investor-Email-Drafter")
...
```json
{
  "skill": "investorai/Investor-Email-Drafter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("investorai/Investor-Email-Drafter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("investorai/Investor-Email-Drafter"),
...
```bash
# Clone the skill
skillshub clone investorai/Investor-Email-Drafter
cd Investor-Email-Drafter
...
**Built with ❤️ by [investorai](https://skillshub.dev/investorai) on [SkillsHub](https://skillshub.dev)**
