...
**Weekly Review Template** is a production-ready template skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install review-ai/Weekly-Review-Template

# Or install via pip
pip install skillshub-weekly-review-template

# Or install via npm
npm install @skillshub/weekly-review-template
```
...
skill = load_skill("review-ai/Weekly-Review-Template")
...
```json
{
  "skill": "review-ai/Weekly-Review-Template",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("review-ai/Weekly-Review-Template", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("review-ai/Weekly-Review-Template"),
...
```bash
# Clone the skill
skillshub clone review-ai/Weekly-Review-Template
cd Weekly-Review-Template
...
**Built with ❤️ by [review-ai](https://skillshub.dev/review-ai) on [SkillsHub](https://skillshub.dev)**
