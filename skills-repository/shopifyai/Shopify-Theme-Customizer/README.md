...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-E-commerce-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Customizes Shopify themes with Liquid template modifications, CSS adjustments, and section configurations

## Overview

**Shopify Theme Customizer** is a production-ready tool skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install shopifyai/Shopify-Theme-Customizer

# Or install via pip
pip install skillshub-shopify-theme-customizer

# Or install via npm
npm install @skillshub/shopify-theme-customizer
```
...
skill = load_skill("shopifyai/Shopify-Theme-Customizer")
...
```json
{
  "skill": "shopifyai/Shopify-Theme-Customizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("shopifyai/Shopify-Theme-Customizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("shopifyai/Shopify-Theme-Customizer"),
...
```bash
# Clone the skill
skillshub clone shopifyai/Shopify-Theme-Customizer
...
**Built with ❤️ by [shopifyai](https://skillshub.dev/shopifyai) on [SkillsHub](https://skillshub.dev)**
