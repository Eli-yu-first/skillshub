...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Project%20Management-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Plans organizational change management with impact assessment, communication plans, and training schedules

## Overview

**Change Management Planner** is a production-ready workflow skill designed for Project Management workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install changeai/Change-Management-Planner

# Or install via pip
pip install skillshub-change-management-planner

# Or install via npm
npm install @skillshub/change-management-planner
```
...
skill = load_skill("changeai/Change-Management-Planner")
...
```json
{
  "skill": "changeai/Change-Management-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("changeai/Change-Management-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("changeai/Change-Management-Planner"),
...
```bash
# Clone the skill
skillshub clone changeai/Change-Management-Planner
cd Change-Management-Planner
...
**Built with ❤️ by [changeai](https://skillshub.dev/changeai) on [SkillsHub](https://skillshub.dev)**
