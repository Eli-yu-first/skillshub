...
**Lesson Plan Generator** is a production-ready agent skill designed for Education & Training workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install lessonai/Lesson-Plan-Generator

# Or install via pip
pip install skillshub-lesson-plan-generator

# Or install via npm
npm install @skillshub/lesson-plan-generator
```
...
skill = load_skill("lessonai/Lesson-Plan-Generator")
...
```json
{
  "skill": "lessonai/Lesson-Plan-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("lessonai/Lesson-Plan-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("lessonai/Lesson-Plan-Generator"),
...
```bash
# Clone the skill
skillshub clone lessonai/Lesson-Plan-Generator
...
**Built with ❤️ by [lessonai](https://skillshub.dev/lessonai) on [SkillsHub](https://skillshub.dev)**
