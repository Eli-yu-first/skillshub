...
**Fact-Check Research Agent** is a production-ready agent skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install verify-ai/Fact-Check-Research-Agent

# Or install via pip
pip install skillshub-fact-check-research-agent

# Or install via npm
npm install @skillshub/fact-check-research-agent
```
...
skill = load_skill("verify-ai/Fact-Check-Research-Agent")
...
```json
{
  "skill": "verify-ai/Fact-Check-Research-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("verify-ai/Fact-Check-Research-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("verify-ai/Fact-Check-Research-Agent"),
...
```bash
# Clone the skill
skillshub clone verify-ai/Fact-Check-Research-Agent
cd Fact-Check-Research-Agent
...
**Built with ❤️ by [verify-ai](https://skillshub.dev/verify-ai) on [SkillsHub](https://skillshub.dev)**
