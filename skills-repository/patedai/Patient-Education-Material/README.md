...
> Creates patient education materials with plain language explanations, visual aids, and multilingual support

## Overview

**Patient Education Material** is a production-ready prompt skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install patedai/Patient-Education-Material

# Or add to your agent configuration
skillshub agent add-skill patedai/Patient-Education-Material
```
...
skill = load_skill("patedai/Patient-Education-Material")
...
```json
{
  "skill": "patedai/Patient-Education-Material",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("patedai/Patient-Education-Material", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("patedai/Patient-Education-Material"),
...
```bash
# Clone the skill
skillshub clone patedai/Patient-Education-Material
cd Patient-Education-Material
...
**Built with ❤️ by [patedai](https://skillshub.dev/patedai) on [SkillsHub](https://skillshub.dev)**
