...
**Accessibility Test Agent** is a production-ready agent skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install a11y-qa/Accessibility-Test-Agent

# Or install via pip
pip install skillshub-accessibility-test-agent

# Or install via npm
npm install @skillshub/accessibility-test-agent
```
...
skill = load_skill("a11y-qa/Accessibility-Test-Agent")
...
```json
{
  "skill": "a11y-qa/Accessibility-Test-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("a11y-qa/Accessibility-Test-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("a11y-qa/Accessibility-Test-Agent"),
...
```bash
# Clone the skill
skillshub clone a11y-qa/Accessibility-Test-Agent
cd Accessibility-Test-Agent
...
**Built with ❤️ by [a11y-qa](https://skillshub.dev/a11y-qa) on [SkillsHub](https://skillshub.dev)**
