...
**Employee Survey Builder** is a production-ready tool skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install surveyhr/Employee-Survey-Builder

# Or install via pip
pip install skillshub-employee-survey-builder

# Or install via npm
npm install @skillshub/employee-survey-builder
```
...
skill = load_skill("surveyhr/Employee-Survey-Builder")
...
```json
{
  "skill": "surveyhr/Employee-Survey-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("surveyhr/Employee-Survey-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("surveyhr/Employee-Survey-Builder"),
...
```bash
# Clone the skill
skillshub clone surveyhr/Employee-Survey-Builder
cd Employee-Survey-Builder
...
**Built with ❤️ by [surveyhr](https://skillshub.dev/surveyhr) on [SkillsHub](https://skillshub.dev)**
