...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Quality%20Assurance-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Design load testing strategies with JMeter/k6 scripts and performance benchmarks

## Overview

**Performance Test Planner** is a production-ready workflow skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install perf-qa/Performance-Test-Planner

# Or install via pip
pip install skillshub-performance-test-planner

# Or install via npm
npm install @skillshub/performance-test-planner
```
...
skill = load_skill("perf-qa/Performance-Test-Planner")
...
```json
{
  "skill": "perf-qa/Performance-Test-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("perf-qa/Performance-Test-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("perf-qa/Performance-Test-Planner"),
...
```bash
# Clone the skill
skillshub clone perf-qa/Performance-Test-Planner
cd Performance-Test-Planner
...
**Built with ❤️ by [perf-qa](https://skillshub.dev/perf-qa) on [SkillsHub](https://skillshub.dev)**
