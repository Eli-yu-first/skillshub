...
**Financial Statement Analyzer** is a production-ready agent skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install finai/Financial-Statement-Analyzer

# Or install via pip
pip install skillshub-financial-statement-analyzer

# Or install via npm
npm install @skillshub/financial-statement-analyzer
```
...
skill = load_skill("finai/Financial-Statement-Analyzer")
...
```json
{
  "skill": "finai/Financial-Statement-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("finai/Financial-Statement-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("finai/Financial-Statement-Analyzer"),
...
```bash
# Clone the skill
skillshub clone finai/Financial-Statement-Analyzer
...
**Built with ❤️ by [finai](https://skillshub.dev/finai) on [SkillsHub](https://skillshub.dev)**
