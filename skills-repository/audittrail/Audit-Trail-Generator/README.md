...
**Audit Trail Generator** is a production-ready tool skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install audittrail/Audit-Trail-Generator

# Or install via pip
pip install skillshub-audit-trail-generator

# Or install via npm
npm install @skillshub/audit-trail-generator
```
...
skill = load_skill("audittrail/Audit-Trail-Generator")
...
```json
{
  "skill": "audittrail/Audit-Trail-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("audittrail/Audit-Trail-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("audittrail/Audit-Trail-Generator"),
...
```bash
# Clone the skill
skillshub clone audittrail/Audit-Trail-Generator
cd Audit-Trail-Generator
...
**Built with ❤️ by [audittrail](https://skillshub.dev/audittrail) on [SkillsHub](https://skillshub.dev)**
