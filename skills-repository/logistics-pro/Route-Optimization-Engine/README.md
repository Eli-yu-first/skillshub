...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Supply%20Chain%20%26%20Logistics-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Optimize delivery routes for multiple vehicles with time windows and capacity constraints

## Overview

**Route Optimization Engine** is a production-ready tool skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install logistics-pro/Route-Optimization-Engine

# Or install via pip
pip install skillshub-route-optimization-engine

# Or install via npm
npm install @skillshub/route-optimization-engine
```
...
skill = load_skill("logistics-pro/Route-Optimization-Engine")
...
```json
{
  "skill": "logistics-pro/Route-Optimization-Engine",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("logistics-pro/Route-Optimization-Engine", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("logistics-pro/Route-Optimization-Engine"),
...
```bash
# Clone the skill
skillshub clone logistics-pro/Route-Optimization-Engine
...
**Built with ❤️ by [logistics-pro](https://skillshub.dev/logistics-pro) on [SkillsHub](https://skillshub.dev)**
