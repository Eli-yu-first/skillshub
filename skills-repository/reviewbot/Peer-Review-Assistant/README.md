...
**Peer Review Assistant** is a production-ready agent skill designed for Academic Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install reviewbot/Peer-Review-Assistant

# Or install via pip
pip install skillshub-peer-review-assistant

# Or install via npm
npm install @skillshub/peer-review-assistant
```
...
skill = load_skill("reviewbot/Peer-Review-Assistant")
...
```json
{
  "skill": "reviewbot/Peer-Review-Assistant",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("reviewbot/Peer-Review-Assistant", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("reviewbot/Peer-Review-Assistant"),
...
```bash
# Clone the skill
skillshub clone reviewbot/Peer-Review-Assistant
...
**Built with ❤️ by [reviewbot](https://skillshub.dev/reviewbot) on [SkillsHub](https://skillshub.dev)**
