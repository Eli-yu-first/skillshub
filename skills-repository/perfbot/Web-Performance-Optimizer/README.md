...
**Web Performance Optimizer** is a production-ready agent skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install perfbot/Web-Performance-Optimizer

# Or install via pip
pip install skillshub-web-performance-optimizer

# Or install via npm
npm install @skillshub/web-performance-optimizer
```
...
skill = load_skill("perfbot/Web-Performance-Optimizer")
...
```json
{
  "skill": "perfbot/Web-Performance-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("perfbot/Web-Performance-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("perfbot/Web-Performance-Optimizer"),
...
```bash
# Clone the skill
skillshub clone perfbot/Web-Performance-Optimizer
cd Web-Performance-Optimizer
...
**Built with ❤️ by [perfbot](https://skillshub.dev/perfbot) on [SkillsHub](https://skillshub.dev)**
