...
**Quiz & Exam Builder** is a production-ready tool skill designed for Education & Training workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install quizai/Quiz-&-Exam-Builder

# Or install via pip
pip install skillshub-quiz-&-exam-builder

# Or install via npm
npm install @skillshub/quiz-&-exam-builder
```
...
skill = load_skill("quizai/Quiz-&-Exam-Builder")
...
```json
{
  "skill": "quizai/Quiz-&-Exam-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("quizai/Quiz-&-Exam-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("quizai/Quiz-&-Exam-Builder"),
...
```bash
# Clone the skill
skillshub clone quizai/Quiz-&-Exam-Builder
cd Quiz-&-Exam-Builder
...
**Built with ❤️ by [quizai](https://skillshub.dev/quizai) on [SkillsHub](https://skillshub.dev)**
