# Composition Advisor Agent

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Photography-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Analyze photo compositions and suggest improvements using rule of thirds, leading lines, and balance

## Overview

**Composition Advisor Agent** is a production-ready agent skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install compose-ai/Composition-Advisor-Agent

# Or install via pip
pip install skillshub-composition-advisor-agent

# Or install via npm
npm install @skillshub/composition-advisor-agent
```
...
skill = load_skill("compose-ai/Composition-Advisor-Agent")
...
```json
{
  "skill": "compose-ai/Composition-Advisor-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("compose-ai/Composition-Advisor-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("compose-ai/Composition-Advisor-Agent"),
...
```bash
# Clone the skill
skillshub clone compose-ai/Composition-Advisor-Agent
cd Composition-Advisor-Agent
...
**Built with ❤️ by [compose-ai](https://skillshub.dev/compose-ai) on [SkillsHub](https://skillshub.dev)**
