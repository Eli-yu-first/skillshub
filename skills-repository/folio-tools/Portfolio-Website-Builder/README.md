...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Photography-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generate photography portfolio websites with gallery layouts and client proofing

## Overview

**Portfolio Website Builder** is a production-ready template skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install folio-tools/Portfolio-Website-Builder

# Or install via pip
pip install skillshub-portfolio-website-builder

# Or install via npm
npm install @skillshub/portfolio-website-builder
```
...
skill = load_skill("folio-tools/Portfolio-Website-Builder")
...
```json
{
  "skill": "folio-tools/Portfolio-Website-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("folio-tools/Portfolio-Website-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("folio-tools/Portfolio-Website-Builder"),
...
```bash
# Clone the skill
skillshub clone folio-tools/Portfolio-Website-Builder
...
**Built with ❤️ by [folio-tools](https://skillshub.dev/folio-tools) on [SkillsHub](https://skillshub.dev)**
