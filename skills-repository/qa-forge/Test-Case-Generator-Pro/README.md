...
> Generate comprehensive test cases from user stories and acceptance criteria

## Overview

**Test Case Generator Pro** is a production-ready agent skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install qa-forge/Test-Case-Generator-Pro

# Or install via pip
pip install skillshub-test-case-generator-pro

# Or install via npm
npm install @skillshub/test-case-generator-pro
```
...
skill = load_skill("qa-forge/Test-Case-Generator-Pro")
...
```json
{
  "skill": "qa-forge/Test-Case-Generator-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("qa-forge/Test-Case-Generator-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("qa-forge/Test-Case-Generator-Pro"),
...
```bash
# Clone the skill
skillshub clone qa-forge/Test-Case-Generator-Pro
cd Test-Case-Generator-Pro
...
**Built with ❤️ by [qa-forge](https://skillshub.dev/qa-forge) on [SkillsHub](https://skillshub.dev)**
