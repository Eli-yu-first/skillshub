...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Photography-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Create color grading presets and LUTs based on mood descriptions and reference images

## Overview

**Color Grading Assistant** is a production-ready prompt skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install grade-ai/Color-Grading-Assistant

# Or add to your agent configuration
skillshub agent add-skill grade-ai/Color-Grading-Assistant
```
...
skill = load_skill("grade-ai/Color-Grading-Assistant")
...
```json
{
  "skill": "grade-ai/Color-Grading-Assistant",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("grade-ai/Color-Grading-Assistant", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("grade-ai/Color-Grading-Assistant"),
...
```bash
# Clone the skill
skillshub clone grade-ai/Color-Grading-Assistant
...
**Built with ❤️ by [grade-ai](https://skillshub.dev/grade-ai) on [SkillsHub](https://skillshub.dev)**
