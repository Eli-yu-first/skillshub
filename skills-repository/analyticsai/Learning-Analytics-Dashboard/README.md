...
**Learning Analytics Dashboard** is a production-ready agent skill designed for Education & Training workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install analyticsai/Learning-Analytics-Dashboard

# Or install via pip
pip install skillshub-learning-analytics-dashboard

# Or install via npm
npm install @skillshub/learning-analytics-dashboard
```
...
skill = load_skill("analyticsai/Learning-Analytics-Dashboard")
...
```json
{
  "skill": "analyticsai/Learning-Analytics-Dashboard",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("analyticsai/Learning-Analytics-Dashboard", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("analyticsai/Learning-Analytics-Dashboard"),
...
```bash
# Clone the skill
skillshub clone analyticsai/Learning-Analytics-Dashboard
...
**Built with ❤️ by [analyticsai](https://skillshub.dev/analyticsai) on [SkillsHub](https://skillshub.dev)**
