...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Fashion%20%26%20Textile-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes fashion product descriptions with brand voice, material details, and styling suggestions

## Overview

**Fashion Copywriter** is a production-ready prompt skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install fashcopy/Fashion-Copywriter

# Or add to your agent configuration
skillshub agent add-skill fashcopy/Fashion-Copywriter
```
...
skill = load_skill("fashcopy/Fashion-Copywriter")
...
```json
{
  "skill": "fashcopy/Fashion-Copywriter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("fashcopy/Fashion-Copywriter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("fashcopy/Fashion-Copywriter"),
...
```bash
# Clone the skill
skillshub clone fashcopy/Fashion-Copywriter
cd Fashion-Copywriter
...
**Built with ❤️ by [fashcopy](https://skillshub.dev/fashcopy) on [SkillsHub](https://skillshub.dev)**
