...
> Calculates travel budgets with cost breakdowns, currency conversion, and expense tracking templates

## Overview

**Travel Budget Calculator** is a production-ready tool skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install budgetai/Travel-Budget-Calculator

# Or install via pip
pip install skillshub-travel-budget-calculator

# Or install via npm
npm install @skillshub/travel-budget-calculator
```
...
skill = load_skill("budgetai/Travel-Budget-Calculator")
...
```json
{
  "skill": "budgetai/Travel-Budget-Calculator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("budgetai/Travel-Budget-Calculator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("budgetai/Travel-Budget-Calculator"),
...
```bash
# Clone the skill
skillshub clone budgetai/Travel-Budget-Calculator
cd Travel-Budget-Calculator
...
**Built with ❤️ by [budgetai](https://skillshub.dev/budgetai) on [SkillsHub](https://skillshub.dev)**
