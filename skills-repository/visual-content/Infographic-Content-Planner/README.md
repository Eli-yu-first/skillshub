...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Content%20Creation-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Plan infographic layouts with data storytelling, visual hierarchy, and brand consistency

## Overview

**Infographic Content Planner** is a production-ready workflow skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install visual-content/Infographic-Content-Planner

# Or install via pip
pip install skillshub-infographic-content-planner

# Or install via npm
npm install @skillshub/infographic-content-planner
```
...
skill = load_skill("visual-content/Infographic-Content-Planner")
...
```json
{
  "skill": "visual-content/Infographic-Content-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("visual-content/Infographic-Content-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("visual-content/Infographic-Content-Planner"),
...
```bash
# Clone the skill
skillshub clone visual-content/Infographic-Content-Planner
cd Infographic-Content-Planner
...
**Built with ❤️ by [visual-content](https://skillshub.dev/visual-content) on [SkillsHub](https://skillshub.dev)**
