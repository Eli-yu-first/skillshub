...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Image%20Creation-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generates social media graphics for Instagram, Twitter, LinkedIn with brand-consistent templates

## Overview

**Social Media Graphics Kit** is a production-ready template skill designed for Image Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install socialai/Social-Media-Graphics-Kit

# Or install via pip
pip install skillshub-social-media-graphics-kit

# Or install via npm
npm install @skillshub/social-media-graphics-kit
```
...
skill = load_skill("socialai/Social-Media-Graphics-Kit")
...
```json
{
  "skill": "socialai/Social-Media-Graphics-Kit",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("socialai/Social-Media-Graphics-Kit", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("socialai/Social-Media-Graphics-Kit"),
...
```bash
# Clone the skill
skillshub clone socialai/Social-Media-Graphics-Kit
cd Social-Media-Graphics-Kit
...
**Built with ❤️ by [socialai](https://skillshub.dev/socialai) on [SkillsHub](https://skillshub.dev)**
