...
**Lease Agreement Drafter** is a production-ready template skill designed for Real Estate workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install leaseai/Lease-Agreement-Drafter

# Or install via pip
pip install skillshub-lease-agreement-drafter

# Or install via npm
npm install @skillshub/lease-agreement-drafter
```
...
skill = load_skill("leaseai/Lease-Agreement-Drafter")
...
```json
{
  "skill": "leaseai/Lease-Agreement-Drafter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("leaseai/Lease-Agreement-Drafter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("leaseai/Lease-Agreement-Drafter"),
...
```bash
# Clone the skill
skillshub clone leaseai/Lease-Agreement-Drafter
cd Lease-Agreement-Drafter
...
**Built with ❤️ by [leaseai](https://skillshub.dev/leaseai) on [SkillsHub](https://skillshub.dev)**
