...
**Drug Interaction Checker** is a production-ready agent skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pharma-tools/Drug-Interaction-Checker
...
skill = load_skill("pharma-tools/Drug-Interaction-Checker")
...
```json
{
  "skill": "pharma-tools/Drug-Interaction-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pharma-tools/Drug-Interaction-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pharma-tools/Drug-Interaction-Checker"),
...
```bash
# Clone the skill
skillshub clone pharma-tools/Drug-Interaction-Checker
...
**Built with ❤️ by [pharma-tools](https://skillshub.dev/pharma-tools) on [SkillsHub](https://skillshub.dev)**
