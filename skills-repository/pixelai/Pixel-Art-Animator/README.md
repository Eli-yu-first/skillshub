...
> Creates pixel art animation sprites with walk cycles, attack animations, and idle sequences

## Overview

**Pixel Art Animator** is a production-ready prompt skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pixelai/Pixel-Art-Animator

# Or add to your agent configuration
skillshub agent add-skill pixelai/Pixel-Art-Animator
```
...
skill = load_skill("pixelai/Pixel-Art-Animator")
...
```json
{
  "skill": "pixelai/Pixel-Art-Animator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pixelai/Pixel-Art-Animator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pixelai/Pixel-Art-Animator"),
...
```bash
# Clone the skill
skillshub clone pixelai/Pixel-Art-Animator
cd Pixel-Art-Animator
...
**Built with ❤️ by [pixelai](https://skillshub.dev/pixelai) on [SkillsHub](https://skillshub.dev)**
