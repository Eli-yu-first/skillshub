...
> Write news articles following AP style with inverted pyramid structure and fact attribution

## Overview

**News Article Writer** is a production-ready prompt skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install press-ai/News-Article-Writer

# Or add to your agent configuration
skillshub agent add-skill press-ai/News-Article-Writer
```
...
skill = load_skill("press-ai/News-Article-Writer")
...
```json
{
  "skill": "press-ai/News-Article-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("press-ai/News-Article-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("press-ai/News-Article-Writer"),
...
```bash
# Clone the skill
skillshub clone press-ai/News-Article-Writer
cd News-Article-Writer
...
**Built with ❤️ by [press-ai](https://skillshub.dev/press-ai) on [SkillsHub](https://skillshub.dev)**
