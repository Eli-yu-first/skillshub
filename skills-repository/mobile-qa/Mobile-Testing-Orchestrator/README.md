...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Quality%20Assurance-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Orchestrate mobile app testing across multiple devices, OS versions, and screen sizes

## Overview

**Mobile Testing Orchestrator** is a production-ready rpa skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mobile-qa/Mobile-Testing-Orchestrator

# Or install via pip
pip install skillshub-mobile-testing-orchestrator

# Or install via npm
npm install @skillshub/mobile-testing-orchestrator
```
...
skill = load_skill("mobile-qa/Mobile-Testing-Orchestrator")
...
```json
{
  "skill": "mobile-qa/Mobile-Testing-Orchestrator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mobile-qa/Mobile-Testing-Orchestrator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mobile-qa/Mobile-Testing-Orchestrator"),
...
```bash
# Clone the skill
skillshub clone mobile-qa/Mobile-Testing-Orchestrator
cd Mobile-Testing-Orchestrator
...
**Built with ❤️ by [mobile-qa](https://skillshub.dev/mobile-qa) on [SkillsHub](https://skillshub.dev)**
