...
> Benchmarks compensation packages against market data with equity analysis and total rewards comparison

## Overview

**Compensation Benchmarker** is a production-ready agent skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install compai/Compensation-Benchmarker

# Or install via pip
pip install skillshub-compensation-benchmarker

# Or install via npm
npm install @skillshub/compensation-benchmarker
```
...
skill = load_skill("compai/Compensation-Benchmarker")
...
```json
{
  "skill": "compai/Compensation-Benchmarker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("compai/Compensation-Benchmarker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("compai/Compensation-Benchmarker"),
...
```bash
# Clone the skill
skillshub clone compai/Compensation-Benchmarker
...
**Built with ❤️ by [compai](https://skillshub.dev/compai) on [SkillsHub](https://skillshub.dev)**
