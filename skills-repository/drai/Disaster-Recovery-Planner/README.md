...
**Disaster Recovery Planner** is a production-ready agent skill designed for DevOps & Cloud workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install drai/Disaster-Recovery-Planner

# Or install via pip
pip install skillshub-disaster-recovery-planner

# Or install via npm
npm install @skillshub/disaster-recovery-planner
```
...
skill = load_skill("drai/Disaster-Recovery-Planner")
...
```json
{
  "skill": "drai/Disaster-Recovery-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("drai/Disaster-Recovery-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("drai/Disaster-Recovery-Planner"),
...
```bash
# Clone the skill
skillshub clone drai/Disaster-Recovery-Planner
cd Disaster-Recovery-Planner
...
**Built with ❤️ by [drai](https://skillshub.dev/drai) on [SkillsHub](https://skillshub.dev)**
