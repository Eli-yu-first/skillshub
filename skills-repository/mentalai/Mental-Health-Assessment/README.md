...
**Mental Health Assessment** is a production-ready prompt skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mentalai/Mental-Health-Assessment

# Or add to your agent configuration
skillshub agent add-skill mentalai/Mental-Health-Assessment
```
...
skill = load_skill("mentalai/Mental-Health-Assessment")
...
```json
{
  "skill": "mentalai/Mental-Health-Assessment",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mentalai/Mental-Health-Assessment", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mentalai/Mental-Health-Assessment"),
...
```bash
# Clone the skill
skillshub clone mentalai/Mental-Health-Assessment
...
**Built with ❤️ by [mentalai](https://skillshub.dev/mentalai) on [SkillsHub](https://skillshub.dev)**
