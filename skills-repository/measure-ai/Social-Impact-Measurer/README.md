...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Non-profit%20%26%20Social%20Impact-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Measure social impact using frameworks like Theory of Change and Social Return on Investment

## Overview

**Social Impact Measurer** is a production-ready tool skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install measure-ai/Social-Impact-Measurer

# Or install via pip
pip install skillshub-social-impact-measurer

# Or install via npm
npm install @skillshub/social-impact-measurer
```
...
skill = load_skill("measure-ai/Social-Impact-Measurer")
...
```json
{
  "skill": "measure-ai/Social-Impact-Measurer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("measure-ai/Social-Impact-Measurer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("measure-ai/Social-Impact-Measurer"),
...
```bash
# Clone the skill
skillshub clone measure-ai/Social-Impact-Measurer
cd Social-Impact-Measurer
...
**Built with ❤️ by [measure-ai](https://skillshub.dev/measure-ai) on [SkillsHub](https://skillshub.dev)**
