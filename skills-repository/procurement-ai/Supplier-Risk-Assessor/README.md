...
> Evaluate supplier reliability, financial health, and geopolitical risk factors

## Overview

**Supplier Risk Assessor** is a production-ready agent skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install procurement-ai/Supplier-Risk-Assessor

# Or install via pip
pip install skillshub-supplier-risk-assessor

# Or install via npm
npm install @skillshub/supplier-risk-assessor
```
...
skill = load_skill("procurement-ai/Supplier-Risk-Assessor")
...
```json
{
  "skill": "procurement-ai/Supplier-Risk-Assessor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("procurement-ai/Supplier-Risk-Assessor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("procurement-ai/Supplier-Risk-Assessor"),
...
```bash
# Clone the skill
skillshub clone procurement-ai/Supplier-Risk-Assessor
cd Supplier-Risk-Assessor
...
**Built with ❤️ by [procurement-ai](https://skillshub.dev/procurement-ai) on [SkillsHub](https://skillshub.dev)**
