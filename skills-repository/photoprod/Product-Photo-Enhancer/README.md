...
**Product Photo Enhancer** is a production-ready tool skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install photoprod/Product-Photo-Enhancer

# Or install via pip
pip install skillshub-product-photo-enhancer

# Or install via npm
npm install @skillshub/product-photo-enhancer
```
...
skill = load_skill("photoprod/Product-Photo-Enhancer")
...
```json
{
  "skill": "photoprod/Product-Photo-Enhancer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("photoprod/Product-Photo-Enhancer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("photoprod/Product-Photo-Enhancer"),
...
```bash
# Clone the skill
skillshub clone photoprod/Product-Photo-Enhancer
cd Product-Photo-Enhancer
...
**Built with ❤️ by [photoprod](https://skillshub.dev/photoprod) on [SkillsHub](https://skillshub.dev)**
