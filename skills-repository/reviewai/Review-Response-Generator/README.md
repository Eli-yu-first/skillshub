...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-E-commerce-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generates professional responses to customer reviews with empathy, resolution offers, and brand voice

## Overview

**Review Response Generator** is a production-ready prompt skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install reviewai/Review-Response-Generator

# Or add to your agent configuration
skillshub agent add-skill reviewai/Review-Response-Generator
```
...
skill = load_skill("reviewai/Review-Response-Generator")
...
```json
{
  "skill": "reviewai/Review-Response-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("reviewai/Review-Response-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("reviewai/Review-Response-Generator"),
...
```bash
# Clone the skill
skillshub clone reviewai/Review-Response-Generator
...
**Built with ❤️ by [reviewai](https://skillshub.dev/reviewai) on [SkillsHub](https://skillshub.dev)**
