...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Video%20Production-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> After Effects and DaVinci Resolve motion graphics templates with customizable parameters

## Overview

**Motion Graphics Template** is a production-ready template skill designed for Video Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mograph/Motion-Graphics-Template

# Or install via pip
pip install skillshub-motion-graphics-template

# Or install via npm
npm install @skillshub/motion-graphics-template
```
...
skill = load_skill("mograph/Motion-Graphics-Template")
...
```json
{
  "skill": "mograph/Motion-Graphics-Template",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mograph/Motion-Graphics-Template", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mograph/Motion-Graphics-Template"),
...
```bash
# Clone the skill
skillshub clone mograph/Motion-Graphics-Template
cd Motion-Graphics-Template
...
**Built with ❤️ by [mograph](https://skillshub.dev/mograph) on [SkillsHub](https://skillshub.dev)**
