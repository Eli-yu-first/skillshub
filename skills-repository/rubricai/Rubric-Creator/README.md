...
**Rubric Creator** is a production-ready tool skill designed for Education & Training workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install rubricai/Rubric-Creator

# Or install via pip
pip install skillshub-rubric-creator

# Or install via npm
npm install @skillshub/rubric-creator
```
...
skill = load_skill("rubricai/Rubric-Creator")
...
skill = load_skill("rubricai/Rubric-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("rubricai/Rubric-Creator"),
...
```bash
# Clone the skill
skillshub clone rubricai/Rubric-Creator
cd Rubric-Creator
...
**Built with ❤️ by [rubricai](https://skillshub.dev/rubricai) on [SkillsHub](https://skillshub.dev)**
