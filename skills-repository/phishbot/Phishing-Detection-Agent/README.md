...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Cybersecurity-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Detects phishing emails and URLs using pattern analysis, domain reputation, and content inspection

## Overview

**Phishing Detection Agent** is a production-ready agent skill designed for Cybersecurity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install phishbot/Phishing-Detection-Agent

# Or install via pip
pip install skillshub-phishing-detection-agent

# Or install via npm
npm install @skillshub/phishing-detection-agent
```
...
skill = load_skill("phishbot/Phishing-Detection-Agent")
...
```json
{
  "skill": "phishbot/Phishing-Detection-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("phishbot/Phishing-Detection-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("phishbot/Phishing-Detection-Agent"),
...
```bash
# Clone the skill
skillshub clone phishbot/Phishing-Detection-Agent
...
**Built with ❤️ by [phishbot](https://skillshub.dev/phishbot) on [SkillsHub](https://skillshub.dev)**
