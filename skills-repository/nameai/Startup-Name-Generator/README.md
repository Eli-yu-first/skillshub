...
**Startup Name Generator** is a production-ready prompt skill designed for Entrepreneurship workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install nameai/Startup-Name-Generator

# Or add to your agent configuration
skillshub agent add-skill nameai/Startup-Name-Generator
```
...
skill = load_skill("nameai/Startup-Name-Generator")
...
```json
{
  "skill": "nameai/Startup-Name-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("nameai/Startup-Name-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("nameai/Startup-Name-Generator"),
...
```bash
# Clone the skill
skillshub clone nameai/Startup-Name-Generator
...
**Built with ❤️ by [nameai](https://skillshub.dev/nameai) on [SkillsHub](https://skillshub.dev)**
