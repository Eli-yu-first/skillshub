...
**NDA Generator** is a production-ready template skill designed for Legal Domain workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install ndaai/NDA-Generator

# Or install via pip
pip install skillshub-nda-generator

# Or install via npm
npm install @skillshub/nda-generator
```
...
skill = load_skill("ndaai/NDA-Generator")
...
skill = load_skill("ndaai/NDA-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("ndaai/NDA-Generator"),
...
```bash
# Clone the skill
skillshub clone ndaai/NDA-Generator
cd NDA-Generator
...
**Built with ❤️ by [ndaai](https://skillshub.dev/ndaai) on [SkillsHub](https://skillshub.dev)**
