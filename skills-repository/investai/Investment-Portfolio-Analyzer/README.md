...
**Investment Portfolio Analyzer** is a production-ready agent skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install investai/Investment-Portfolio-Analyzer

# Or install via pip
pip install skillshub-investment-portfolio-analyzer

# Or install via npm
npm install @skillshub/investment-portfolio-analyzer
```
...
skill = load_skill("investai/Investment-Portfolio-Analyzer")
...
```json
{
  "skill": "investai/Investment-Portfolio-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("investai/Investment-Portfolio-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("investai/Investment-Portfolio-Analyzer"),
...
```bash
# Clone the skill
skillshub clone investai/Investment-Portfolio-Analyzer
...
**Built with ❤️ by [investai](https://skillshub.dev/investai) on [SkillsHub](https://skillshub.dev)**
