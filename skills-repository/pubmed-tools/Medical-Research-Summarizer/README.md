...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Healthcare%20%26%20Medical-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Summarize medical research papers and extract key findings, methods, and conclusions

## Overview

**Medical Research Summarizer** is a production-ready prompt skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pubmed-tools/Medical-Research-Summarizer

# Or add to your agent configuration
skillshub agent add-skill pubmed-tools/Medical-Research-Summarizer
```
...
skill = load_skill("pubmed-tools/Medical-Research-Summarizer")
...
```json
{
  "skill": "pubmed-tools/Medical-Research-Summarizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pubmed-tools/Medical-Research-Summarizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pubmed-tools/Medical-Research-Summarizer"),
...
```bash
# Clone the skill
skillshub clone pubmed-tools/Medical-Research-Summarizer
...
**Built with ❤️ by [pubmed-tools](https://skillshub.dev/pubmed-tools) on [SkillsHub](https://skillshub.dev)**
