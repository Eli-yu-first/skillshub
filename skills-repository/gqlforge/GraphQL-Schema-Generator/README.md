...
**GraphQL Schema Generator** is a production-ready tool skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install gqlforge/GraphQL-Schema-Generator

# Or install via pip
pip install skillshub-graphql-schema-generator

# Or install via npm
npm install @skillshub/graphql-schema-generator
```
...
skill = load_skill("gqlforge/GraphQL-Schema-Generator")
...
```json
{
  "skill": "gqlforge/GraphQL-Schema-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("gqlforge/GraphQL-Schema-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("gqlforge/GraphQL-Schema-Generator"),
...
```bash
# Clone the skill
skillshub clone gqlforge/GraphQL-Schema-Generator
...
**Built with ❤️ by [gqlforge](https://skillshub.dev/gqlforge) on [SkillsHub](https://skillshub.dev)**
