...
**Interior Style Recommender** is a production-ready agent skill designed for Architecture & Interior Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install interiorai/Interior-Style-Recommender

# Or install via pip
pip install skillshub-interior-style-recommender

# Or install via npm
npm install @skillshub/interior-style-recommender
```
...
skill = load_skill("interiorai/Interior-Style-Recommender")
...
```json
{
  "skill": "interiorai/Interior-Style-Recommender",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("interiorai/Interior-Style-Recommender", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("interiorai/Interior-Style-Recommender"),
...
```bash
# Clone the skill
skillshub clone interiorai/Interior-Style-Recommender
...
**Built with ❤️ by [interiorai](https://skillshub.dev/interiorai) on [SkillsHub](https://skillshub.dev)**
