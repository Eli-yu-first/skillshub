...
**Pitch Deck Creator** is a production-ready workflow skill designed for Entrepreneurship workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pitchai/Pitch-Deck-Creator

# Or install via pip
pip install skillshub-pitch-deck-creator

# Or install via npm
npm install @skillshub/pitch-deck-creator
```
...
skill = load_skill("pitchai/Pitch-Deck-Creator")
...
```json
{
  "skill": "pitchai/Pitch-Deck-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pitchai/Pitch-Deck-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pitchai/Pitch-Deck-Creator"),
...
```bash
# Clone the skill
skillshub clone pitchai/Pitch-Deck-Creator
...
**Built with ❤️ by [pitchai](https://skillshub.dev/pitchai) on [SkillsHub](https://skillshub.dev)**
