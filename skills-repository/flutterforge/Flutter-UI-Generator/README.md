...
**Flutter UI Generator** is a production-ready prompt skill designed for App Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install flutterforge/Flutter-UI-Generator

# Or add to your agent configuration
skillshub agent add-skill flutterforge/Flutter-UI-Generator
```
...
skill = load_skill("flutterforge/Flutter-UI-Generator")
...
```json
{
  "skill": "flutterforge/Flutter-UI-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("flutterforge/Flutter-UI-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("flutterforge/Flutter-UI-Generator"),
...
```bash
# Clone the skill
skillshub clone flutterforge/Flutter-UI-Generator
cd Flutter-UI-Generator
...
**Built with ❤️ by [flutterforge](https://skillshub.dev/flutterforge) on [SkillsHub](https://skillshub.dev)**
