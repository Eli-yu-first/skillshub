# Tour Guide Script Writer

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Travel%20%26%20Hospitality-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes tour guide scripts with historical facts, storytelling elements, and audience engagement techniques

## Overview

**Tour Guide Script Writer** is a production-ready prompt skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tourguide/Tour-Guide-Script-Writer

# Or add to your agent configuration
skillshub agent add-skill tourguide/Tour-Guide-Script-Writer
```
...
skill = load_skill("tourguide/Tour-Guide-Script-Writer")
...
```json
{
  "skill": "tourguide/Tour-Guide-Script-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tourguide/Tour-Guide-Script-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tourguide/Tour-Guide-Script-Writer"),
...
```bash
# Clone the skill
skillshub clone tourguide/Tour-Guide-Script-Writer
cd Tour-Guide-Script-Writer
...
**Built with ❤️ by [tourguide](https://skillshub.dev/tourguide) on [SkillsHub](https://skillshub.dev)**
