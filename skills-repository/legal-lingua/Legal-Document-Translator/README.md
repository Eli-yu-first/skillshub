...
> Translate legal documents with precise terminology and jurisdiction-specific adaptations

## Overview

**Legal Document Translator** is a production-ready agent skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install legal-lingua/Legal-Document-Translator

# Or install via pip
pip install skillshub-legal-document-translator

# Or install via npm
npm install @skillshub/legal-document-translator
```
...
skill = load_skill("legal-lingua/Legal-Document-Translator")
...
```json
{
  "skill": "legal-lingua/Legal-Document-Translator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("legal-lingua/Legal-Document-Translator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("legal-lingua/Legal-Document-Translator"),
...
```bash
# Clone the skill
skillshub clone legal-lingua/Legal-Document-Translator
...
**Built with ❤️ by [legal-lingua](https://skillshub.dev/legal-lingua) on [SkillsHub](https://skillshub.dev)**
