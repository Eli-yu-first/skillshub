...
**Editorial Calendar Planner** is a production-ready agent skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install edit-tools/Editorial-Calendar-Planner

# Or install via pip
pip install skillshub-editorial-calendar-planner

# Or install via npm
npm install @skillshub/editorial-calendar-planner
```
...
skill = load_skill("edit-tools/Editorial-Calendar-Planner")
...
```json
{
  "skill": "edit-tools/Editorial-Calendar-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("edit-tools/Editorial-Calendar-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("edit-tools/Editorial-Calendar-Planner"),
...
```bash
# Clone the skill
skillshub clone edit-tools/Editorial-Calendar-Planner
cd Editorial-Calendar-Planner
...
**Built with ❤️ by [edit-tools](https://skillshub.dev/edit-tools) on [SkillsHub](https://skillshub.dev)**
