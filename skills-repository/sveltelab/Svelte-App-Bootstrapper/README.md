...
> Bootstraps SvelteKit applications with TypeScript, Drizzle ORM, authentication, and deployment configs

## Overview

**Svelte App Bootstrapper** is a production-ready workflow skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sveltelab/Svelte-App-Bootstrapper

# Or install via pip
pip install skillshub-svelte-app-bootstrapper

# Or install via npm
npm install @skillshub/svelte-app-bootstrapper
```
...
skill = load_skill("sveltelab/Svelte-App-Bootstrapper")
...
```json
{
  "skill": "sveltelab/Svelte-App-Bootstrapper",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sveltelab/Svelte-App-Bootstrapper", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sveltelab/Svelte-App-Bootstrapper"),
...
```bash
# Clone the skill
skillshub clone sveltelab/Svelte-App-Bootstrapper
cd Svelte-App-Bootstrapper
...
**Built with ❤️ by [sveltelab](https://skillshub.dev/sveltelab) on [SkillsHub](https://skillshub.dev)**
