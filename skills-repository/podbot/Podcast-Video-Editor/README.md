...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Video%20Production-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Automates podcast video editing with speaker detection, highlight clips, and social media cuts

## Overview

**Podcast Video Editor** is a production-ready workflow skill designed for Video Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install podbot/Podcast-Video-Editor

# Or install via pip
pip install skillshub-podcast-video-editor

# Or install via npm
npm install @skillshub/podcast-video-editor
```
...
skill = load_skill("podbot/Podcast-Video-Editor")
...
```json
{
  "skill": "podbot/Podcast-Video-Editor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("podbot/Podcast-Video-Editor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("podbot/Podcast-Video-Editor"),
...
```bash
# Clone the skill
skillshub clone podbot/Podcast-Video-Editor
...
**Built with ❤️ by [podbot](https://skillshub.dev/podbot) on [SkillsHub](https://skillshub.dev)**
