...
**Electron Desktop Builder** is a production-ready workflow skill designed for App Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install desktopai/Electron-Desktop-Builder

# Or install via pip
pip install skillshub-electron-desktop-builder

# Or install via npm
npm install @skillshub/electron-desktop-builder
```
...
skill = load_skill("desktopai/Electron-Desktop-Builder")
...
```json
{
  "skill": "desktopai/Electron-Desktop-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("desktopai/Electron-Desktop-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("desktopai/Electron-Desktop-Builder"),
...
```bash
# Clone the skill
skillshub clone desktopai/Electron-Desktop-Builder
cd Electron-Desktop-Builder
...
**Built with ❤️ by [desktopai](https://skillshub.dev/desktopai) on [SkillsHub](https://skillshub.dev)**
