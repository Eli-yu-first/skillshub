...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Translation%20%26%20Localization-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Translate and time-sync subtitles for video content with proper reading speed constraints

## Overview

**Subtitle Translation Engine** is a production-ready workflow skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sub-translate/Subtitle-Translation-Engine

# Or install via pip
pip install skillshub-subtitle-translation-engine

# Or install via npm
npm install @skillshub/subtitle-translation-engine
```
...
skill = load_skill("sub-translate/Subtitle-Translation-Engine")
...
```json
{
  "skill": "sub-translate/Subtitle-Translation-Engine",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sub-translate/Subtitle-Translation-Engine", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sub-translate/Subtitle-Translation-Engine"),
...
```bash
# Clone the skill
skillshub clone sub-translate/Subtitle-Translation-Engine
cd Subtitle-Translation-Engine
...
**Built with ❤️ by [sub-translate](https://skillshub.dev/sub-translate) on [SkillsHub](https://skillshub.dev)**
