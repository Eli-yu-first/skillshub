...
**CNC Program Generator** is a production-ready tool skill designed for Manufacturing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install cnc-tools/CNC-Program-Generator

# Or install via pip
pip install skillshub-cnc-program-generator

# Or install via npm
npm install @skillshub/cnc-program-generator
```
...
skill = load_skill("cnc-tools/CNC-Program-Generator")
...
```json
{
  "skill": "cnc-tools/CNC-Program-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("cnc-tools/CNC-Program-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("cnc-tools/CNC-Program-Generator"),
...
```bash
# Clone the skill
skillshub clone cnc-tools/CNC-Program-Generator
cd CNC-Program-Generator
...
**Built with ❤️ by [cnc-tools](https://skillshub.dev/cnc-tools) on [SkillsHub](https://skillshub.dev)**
