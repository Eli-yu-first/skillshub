...
**Face Detection System** is a production-ready tool skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install faceai/Face-Detection-System

# Or install via pip
pip install skillshub-face-detection-system

# Or install via npm
npm install @skillshub/face-detection-system
```
...
skill = load_skill("faceai/Face-Detection-System")
...
```json
{
  "skill": "faceai/Face-Detection-System",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("faceai/Face-Detection-System", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("faceai/Face-Detection-System"),
...
```bash
# Clone the skill
skillshub clone faceai/Face-Detection-System
...
**Built with ❤️ by [faceai](https://skillshub.dev/faceai) on [SkillsHub](https://skillshub.dev)**
