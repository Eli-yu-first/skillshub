...
**Property Listing Writer** is a production-ready prompt skill designed for Real Estate workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install listingai/Property-Listing-Writer

# Or add to your agent configuration
skillshub agent add-skill listingai/Property-Listing-Writer
```
...
skill = load_skill("listingai/Property-Listing-Writer")
...
```json
{
  "skill": "listingai/Property-Listing-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("listingai/Property-Listing-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("listingai/Property-Listing-Writer"),
...
```bash
# Clone the skill
skillshub clone listingai/Property-Listing-Writer
cd Property-Listing-Writer
...
**Built with ❤️ by [listingai](https://skillshub.dev/listingai) on [SkillsHub](https://skillshub.dev)**
