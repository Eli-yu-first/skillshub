...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Marketing%20%26%20SEO-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes high-converting landing page copy with headlines, value propositions, and CTAs using proven frameworks

## Overview

**Landing Page Copywriter** is a production-ready prompt skill designed for Marketing & SEO workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install copyai/Landing-Page-Copywriter

# Or add to your agent configuration
skillshub agent add-skill copyai/Landing-Page-Copywriter
```
...
skill = load_skill("copyai/Landing-Page-Copywriter")
...
```json
{
  "skill": "copyai/Landing-Page-Copywriter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("copyai/Landing-Page-Copywriter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("copyai/Landing-Page-Copywriter"),
...
```bash
# Clone the skill
skillshub clone copyai/Landing-Page-Copywriter
cd Landing-Page-Copywriter
...
**Built with ❤️ by [copyai](https://skillshub.dev/copyai) on [SkillsHub](https://skillshub.dev)**
