...
**Procurement Contract Analyzer** is a production-ready agent skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install procure-ai/Procurement-Contract-Analyzer

# Or install via pip
pip install skillshub-procurement-contract-analyzer

# Or install via npm
npm install @skillshub/procurement-contract-analyzer
```
...
skill = load_skill("procure-ai/Procurement-Contract-Analyzer")
...
```json
{
  "skill": "procure-ai/Procurement-Contract-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("procure-ai/Procurement-Contract-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("procure-ai/Procurement-Contract-Analyzer"),
...
```bash
# Clone the skill
skillshub clone procure-ai/Procurement-Contract-Analyzer
cd Procurement-Contract-Analyzer
...
**Built with ❤️ by [procure-ai](https://skillshub.dev/procure-ai) on [SkillsHub](https://skillshub.dev)**
