...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Computer%20Vision-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Analyzes medical images (X-ray, MRI, CT) with anomaly detection and measurement tools

## Overview

**Medical Image Analyzer** is a production-ready agent skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install medimgai/Medical-Image-Analyzer

# Or install via pip
pip install skillshub-medical-image-analyzer

# Or install via npm
npm install @skillshub/medical-image-analyzer
```
...
skill = load_skill("medimgai/Medical-Image-Analyzer")
...
```json
{
  "skill": "medimgai/Medical-Image-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("medimgai/Medical-Image-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("medimgai/Medical-Image-Analyzer"),
...
```bash
# Clone the skill
skillshub clone medimgai/Medical-Image-Analyzer
...
**Built with ❤️ by [medimgai](https://skillshub.dev/medimgai) on [SkillsHub](https://skillshub.dev)**
