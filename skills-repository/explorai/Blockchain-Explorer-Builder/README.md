...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Blockchain%20%26%20Web3-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Builds blockchain explorers with transaction tracking, address analytics, and contract verification

## Overview

**Blockchain Explorer Builder** is a production-ready workflow skill designed for Blockchain & Web3 workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install explorai/Blockchain-Explorer-Builder

# Or install via pip
pip install skillshub-blockchain-explorer-builder

# Or install via npm
npm install @skillshub/blockchain-explorer-builder
```
...
skill = load_skill("explorai/Blockchain-Explorer-Builder")
...
```json
{
  "skill": "explorai/Blockchain-Explorer-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("explorai/Blockchain-Explorer-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("explorai/Blockchain-Explorer-Builder"),
...
```bash
# Clone the skill
skillshub clone explorai/Blockchain-Explorer-Builder
cd Blockchain-Explorer-Builder
...
**Built with ❤️ by [explorai](https://skillshub.dev/explorai) on [SkillsHub](https://skillshub.dev)**
