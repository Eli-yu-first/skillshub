...
**Sustainable Design Advisor** is a production-ready agent skill designed for Architecture & Interior Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sustaindesign/Sustainable-Design-Advisor

# Or install via pip
pip install skillshub-sustainable-design-advisor

# Or install via npm
npm install @skillshub/sustainable-design-advisor
```
...
skill = load_skill("sustaindesign/Sustainable-Design-Advisor")
...
```json
{
  "skill": "sustaindesign/Sustainable-Design-Advisor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sustaindesign/Sustainable-Design-Advisor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sustaindesign/Sustainable-Design-Advisor"),
...
```bash
# Clone the skill
skillshub clone sustaindesign/Sustainable-Design-Advisor
cd Sustainable-Design-Advisor
...
**Built with ❤️ by [sustaindesign](https://skillshub.dev/sustaindesign) on [SkillsHub](https://skillshub.dev)**
