...
**Meeting Agenda Builder** is a production-ready prompt skill designed for Project Management workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install agendaai/Meeting-Agenda-Builder

# Or add to your agent configuration
skillshub agent add-skill agendaai/Meeting-Agenda-Builder
```
...
skill = load_skill("agendaai/Meeting-Agenda-Builder")
...
```json
{
  "skill": "agendaai/Meeting-Agenda-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("agendaai/Meeting-Agenda-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("agendaai/Meeting-Agenda-Builder"),
...
```bash
# Clone the skill
skillshub clone agendaai/Meeting-Agenda-Builder
cd Meeting-Agenda-Builder
...
**Built with ❤️ by [agendaai](https://skillshub.dev/agendaai) on [SkillsHub](https://skillshub.dev)**
