...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Architecture%20%26%20Interior%20Design-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Optimizes space planning with furniture arrangement, circulation analysis, and accessibility compliance

## Overview

**Space Planning Optimizer** is a production-ready agent skill designed for Architecture & Interior Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install spaceai/Space-Planning-Optimizer

# Or install via pip
pip install skillshub-space-planning-optimizer

# Or install via npm
npm install @skillshub/space-planning-optimizer
```
...
skill = load_skill("spaceai/Space-Planning-Optimizer")
...
```json
{
  "skill": "spaceai/Space-Planning-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("spaceai/Space-Planning-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("spaceai/Space-Planning-Optimizer"),
...
```bash
# Clone the skill
skillshub clone spaceai/Space-Planning-Optimizer
cd Space-Planning-Optimizer
...
**Built with ❤️ by [spaceai](https://skillshub.dev/spaceai) on [SkillsHub](https://skillshub.dev)**
