...
**Terraform Module Creator** is a production-ready tool skill designed for DevOps & Cloud workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install terraformai/Terraform-Module-Creator

# Or install via pip
pip install skillshub-terraform-module-creator

# Or install via npm
npm install @skillshub/terraform-module-creator
```
...
skill = load_skill("terraformai/Terraform-Module-Creator")
...
```json
{
  "skill": "terraformai/Terraform-Module-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("terraformai/Terraform-Module-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("terraformai/Terraform-Module-Creator"),
...
```bash
# Clone the skill
skillshub clone terraformai/Terraform-Module-Creator
cd Terraform-Module-Creator
...
**Built with ❤️ by [terraformai](https://skillshub.dev/terraformai) on [SkillsHub](https://skillshub.dev)**
