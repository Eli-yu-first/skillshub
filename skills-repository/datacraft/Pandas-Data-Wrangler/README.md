...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Data%20Science-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generates Pandas code for data cleaning, transformation, and feature engineering from natural language

## Overview

**Pandas Data Wrangler** is a production-ready prompt skill designed for Data Science workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install datacraft/Pandas-Data-Wrangler

# Or add to your agent configuration
skillshub agent add-skill datacraft/Pandas-Data-Wrangler
```
...
skill = load_skill("datacraft/Pandas-Data-Wrangler")
...
```json
{
  "skill": "datacraft/Pandas-Data-Wrangler",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("datacraft/Pandas-Data-Wrangler", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("datacraft/Pandas-Data-Wrangler"),
...
```bash
# Clone the skill
skillshub clone datacraft/Pandas-Data-Wrangler
cd Pandas-Data-Wrangler
...
**Built with ❤️ by [datacraft](https://skillshub.dev/datacraft) on [SkillsHub](https://skillshub.dev)**
