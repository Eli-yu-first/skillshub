...
> Forecast product demand using historical data, seasonality, and market trends

## Overview

**Demand Forecasting Agent** is a production-ready agent skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install supply-ai/Demand-Forecasting-Agent

# Or install via pip
pip install skillshub-demand-forecasting-agent

# Or install via npm
npm install @skillshub/demand-forecasting-agent
```
...
skill = load_skill("supply-ai/Demand-Forecasting-Agent")
...
```json
{
  "skill": "supply-ai/Demand-Forecasting-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("supply-ai/Demand-Forecasting-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("supply-ai/Demand-Forecasting-Agent"),
...
```bash
# Clone the skill
skillshub clone supply-ai/Demand-Forecasting-Agent
...
**Built with ❤️ by [supply-ai](https://skillshub.dev/supply-ai) on [SkillsHub](https://skillshub.dev)**
