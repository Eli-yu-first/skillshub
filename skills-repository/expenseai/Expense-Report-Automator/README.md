...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Finance%20%26%20Accounting-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Automates expense report creation from receipts with OCR, categorization, and policy compliance

## Overview

**Expense Report Automator** is a production-ready rpa skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install expenseai/Expense-Report-Automator

# Or install via pip
pip install skillshub-expense-report-automator

# Or install via npm
npm install @skillshub/expense-report-automator
```
...
skill = load_skill("expenseai/Expense-Report-Automator")
...
```json
{
  "skill": "expenseai/Expense-Report-Automator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("expenseai/Expense-Report-Automator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("expenseai/Expense-Report-Automator"),
...
```bash
# Clone the skill
skillshub clone expenseai/Expense-Report-Automator
cd Expense-Report-Automator
...
**Built with ❤️ by [expenseai](https://skillshub.dev/expenseai) on [SkillsHub](https://skillshub.dev)**
