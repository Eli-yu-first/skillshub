...
> Builds yoga sequences with pose transitions, difficulty progression, and breathing pattern integration

## Overview

**Yoga Sequence Builder** is a production-ready tool skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install yogaai/Yoga-Sequence-Builder

# Or install via pip
pip install skillshub-yoga-sequence-builder

# Or install via npm
npm install @skillshub/yoga-sequence-builder
```
...
skill = load_skill("yogaai/Yoga-Sequence-Builder")
...
```json
{
  "skill": "yogaai/Yoga-Sequence-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("yogaai/Yoga-Sequence-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("yogaai/Yoga-Sequence-Builder"),
...
```bash
# Clone the skill
skillshub clone yogaai/Yoga-Sequence-Builder
cd Yoga-Sequence-Builder
...
**Built with ❤️ by [yogaai](https://skillshub.dev/yogaai) on [SkillsHub](https://skillshub.dev)**
