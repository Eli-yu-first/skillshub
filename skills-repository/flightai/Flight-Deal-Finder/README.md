...
**Flight Deal Finder** is a production-ready agent skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install flightai/Flight-Deal-Finder

# Or install via pip
pip install skillshub-flight-deal-finder

# Or install via npm
npm install @skillshub/flight-deal-finder
```
...
skill = load_skill("flightai/Flight-Deal-Finder")
...
```json
{
  "skill": "flightai/Flight-Deal-Finder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("flightai/Flight-Deal-Finder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("flightai/Flight-Deal-Finder"),
...
```bash
# Clone the skill
skillshub clone flightai/Flight-Deal-Finder
...
**Built with ❤️ by [flightai](https://skillshub.dev/flightai) on [SkillsHub](https://skillshub.dev)**
