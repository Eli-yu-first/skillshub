...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Manufacturing-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Audit manufacturing facilities for OSHA compliance and safety standard adherence

## Overview

**Safety Compliance Checker** is a production-ready rpa skill designed for Manufacturing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install safety-mfg/Safety-Compliance-Checker

# Or install via pip
pip install skillshub-safety-compliance-checker

# Or install via npm
npm install @skillshub/safety-compliance-checker
```
...
skill = load_skill("safety-mfg/Safety-Compliance-Checker")
...
```json
{
  "skill": "safety-mfg/Safety-Compliance-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("safety-mfg/Safety-Compliance-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("safety-mfg/Safety-Compliance-Checker"),
...
```bash
# Clone the skill
skillshub clone safety-mfg/Safety-Compliance-Checker
cd Safety-Compliance-Checker
...
**Built with ❤️ by [safety-mfg](https://skillshub.dev/safety-mfg) on [SkillsHub](https://skillshub.dev)**
