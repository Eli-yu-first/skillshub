...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Personal%20Development-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Build weighted decision matrices for complex life and career decisions

## Overview

**Decision Matrix Builder** is a production-ready tool skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install decide-tools/Decision-Matrix-Builder

# Or install via pip
pip install skillshub-decision-matrix-builder

# Or install via npm
npm install @skillshub/decision-matrix-builder
```
...
skill = load_skill("decide-tools/Decision-Matrix-Builder")
...
```json
{
  "skill": "decide-tools/Decision-Matrix-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("decide-tools/Decision-Matrix-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("decide-tools/Decision-Matrix-Builder"),
...
```bash
# Clone the skill
skillshub clone decide-tools/Decision-Matrix-Builder
...
**Built with ❤️ by [decide-tools](https://skillshub.dev/decide-tools) on [SkillsHub](https://skillshub.dev)**
