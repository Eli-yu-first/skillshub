# Background Art Prompter

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Animation%20Production-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Creates detailed background art prompts for animation scenes with perspective, lighting, and mood specifications

## Overview

**Background Art Prompter** is a production-ready prompt skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bgartai/Background-Art-Prompter

# Or add to your agent configuration
skillshub agent add-skill bgartai/Background-Art-Prompter
```
...
skill = load_skill("bgartai/Background-Art-Prompter")
...
```json
{
  "skill": "bgartai/Background-Art-Prompter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bgartai/Background-Art-Prompter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bgartai/Background-Art-Prompter"),
...
```bash
# Clone the skill
skillshub clone bgartai/Background-Art-Prompter
cd Background-Art-Prompter
...
**Built with ❤️ by [bgartai](https://skillshub.dev/bgartai) on [SkillsHub](https://skillshub.dev)**
