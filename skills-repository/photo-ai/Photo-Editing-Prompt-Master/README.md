...
**Photo Editing Prompt Master** is a production-ready prompt skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install photo-ai/Photo-Editing-Prompt-Master

# Or add to your agent configuration
skillshub agent add-skill photo-ai/Photo-Editing-Prompt-Master
```
...
skill = load_skill("photo-ai/Photo-Editing-Prompt-Master")
...
```json
{
  "skill": "photo-ai/Photo-Editing-Prompt-Master",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("photo-ai/Photo-Editing-Prompt-Master", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("photo-ai/Photo-Editing-Prompt-Master"),
...
```bash
# Clone the skill
skillshub clone photo-ai/Photo-Editing-Prompt-Master
cd Photo-Editing-Prompt-Master
...
**Built with ❤️ by [photo-ai](https://skillshub.dev/photo-ai) on [SkillsHub](https://skillshub.dev)**
