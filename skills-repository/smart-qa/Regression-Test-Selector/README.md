...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Quality%20Assurance-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Intelligently select regression test subsets based on code changes and risk analysis

## Overview

**Regression Test Selector** is a production-ready agent skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install smart-qa/Regression-Test-Selector

# Or install via pip
pip install skillshub-regression-test-selector

# Or install via npm
npm install @skillshub/regression-test-selector
```
...
skill = load_skill("smart-qa/Regression-Test-Selector")
...
```json
{
  "skill": "smart-qa/Regression-Test-Selector",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("smart-qa/Regression-Test-Selector", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("smart-qa/Regression-Test-Selector"),
...
```bash
# Clone the skill
skillshub clone smart-qa/Regression-Test-Selector
cd Regression-Test-Selector
...
**Built with ❤️ by [smart-qa](https://skillshub.dev/smart-qa) on [SkillsHub](https://skillshub.dev)**
