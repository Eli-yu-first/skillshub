...
**Tax Preparation Assistant** is a production-ready agent skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install taxai/Tax-Preparation-Assistant

# Or install via pip
pip install skillshub-tax-preparation-assistant

# Or install via npm
npm install @skillshub/tax-preparation-assistant
```
...
skill = load_skill("taxai/Tax-Preparation-Assistant")
...
```json
{
  "skill": "taxai/Tax-Preparation-Assistant",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("taxai/Tax-Preparation-Assistant", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("taxai/Tax-Preparation-Assistant"),
...
```bash
# Clone the skill
skillshub clone taxai/Tax-Preparation-Assistant
cd Tax-Preparation-Assistant
...
**Built with ❤️ by [taxai](https://skillshub.dev/taxai) on [SkillsHub](https://skillshub.dev)**
