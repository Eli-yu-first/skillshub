...
**Unreal Blueprint Advisor** is a production-ready agent skill designed for Game Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install unreal-tools/Unreal-Blueprint-Advisor

# Or install via pip
pip install skillshub-unreal-blueprint-advisor

# Or install via npm
npm install @skillshub/unreal-blueprint-advisor
```
...
skill = load_skill("unreal-tools/Unreal-Blueprint-Advisor")
...
```json
{
  "skill": "unreal-tools/Unreal-Blueprint-Advisor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("unreal-tools/Unreal-Blueprint-Advisor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("unreal-tools/Unreal-Blueprint-Advisor"),
...
```bash
# Clone the skill
skillshub clone unreal-tools/Unreal-Blueprint-Advisor
cd Unreal-Blueprint-Advisor
...
**Built with ❤️ by [unreal-tools](https://skillshub.dev/unreal-tools) on [SkillsHub](https://skillshub.dev)**
