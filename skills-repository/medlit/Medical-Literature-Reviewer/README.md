...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-General-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Reviews medical literature with evidence grading, study quality assessment, and clinical relevance scoring

## Overview

**Medical Literature Reviewer** is a production-ready agent skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install medlit/Medical-Literature-Reviewer

# Or install via pip
pip install skillshub-medical-literature-reviewer

# Or install via npm
npm install @skillshub/medical-literature-reviewer
```
...
skill = load_skill("medlit/Medical-Literature-Reviewer")
...
```json
{
  "skill": "medlit/Medical-Literature-Reviewer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("medlit/Medical-Literature-Reviewer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("medlit/Medical-Literature-Reviewer"),
...
```bash
# Clone the skill
skillshub clone medlit/Medical-Literature-Reviewer
cd Medical-Literature-Reviewer
...
**Built with ❤️ by [medlit](https://skillshub.dev/medlit) on [SkillsHub](https://skillshub.dev)**
