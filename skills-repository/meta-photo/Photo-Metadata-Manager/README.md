...
**Photo Metadata Manager** is a production-ready tool skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install meta-photo/Photo-Metadata-Manager

# Or install via pip
pip install skillshub-photo-metadata-manager

# Or install via npm
npm install @skillshub/photo-metadata-manager
```
...
skill = load_skill("meta-photo/Photo-Metadata-Manager")
...
```json
{
  "skill": "meta-photo/Photo-Metadata-Manager",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("meta-photo/Photo-Metadata-Manager", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("meta-photo/Photo-Metadata-Manager"),
...
```bash
# Clone the skill
skillshub clone meta-photo/Photo-Metadata-Manager
...
**Built with ❤️ by [meta-photo](https://skillshub.dev/meta-photo) on [SkillsHub](https://skillshub.dev)**
