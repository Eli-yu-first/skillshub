...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Marketing%20%26%20SEO-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Builds automated email sequences for onboarding, nurturing, and re-engagement with A/B test variants

## Overview

**Email Sequence Builder** is a production-ready workflow skill designed for Marketing & SEO workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install seqai/Email-Sequence-Builder

# Or install via pip
pip install skillshub-email-sequence-builder

# Or install via npm
npm install @skillshub/email-sequence-builder
```
...
skill = load_skill("seqai/Email-Sequence-Builder")
...
```json
{
  "skill": "seqai/Email-Sequence-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("seqai/Email-Sequence-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("seqai/Email-Sequence-Builder"),
...
```bash
# Clone the skill
skillshub clone seqai/Email-Sequence-Builder
cd Email-Sequence-Builder
...
**Built with ❤️ by [seqai](https://skillshub.dev/seqai) on [SkillsHub](https://skillshub.dev)**
