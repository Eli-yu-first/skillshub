...
**Motion Path Generator** is a production-ready tool skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install motionai/Motion-Path-Generator

# Or install via pip
pip install skillshub-motion-path-generator

# Or install via npm
npm install @skillshub/motion-path-generator
```
...
skill = load_skill("motionai/Motion-Path-Generator")
...
```json
{
  "skill": "motionai/Motion-Path-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("motionai/Motion-Path-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("motionai/Motion-Path-Generator"),
...
```bash
# Clone the skill
skillshub clone motionai/Motion-Path-Generator
cd Motion-Path-Generator
...
**Built with ❤️ by [motionai](https://skillshub.dev/motionai) on [SkillsHub](https://skillshub.dev)**
