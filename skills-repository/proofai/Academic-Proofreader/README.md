...
> Proofreads academic writing for grammar, style consistency, jargon clarity, and formal tone

## Overview

**Academic Proofreader** is a production-ready tool skill designed for Academic Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install proofai/Academic-Proofreader

# Or install via pip
pip install skillshub-academic-proofreader

# Or install via npm
npm install @skillshub/academic-proofreader
```
...
skill = load_skill("proofai/Academic-Proofreader")
...
```json
{
  "skill": "proofai/Academic-Proofreader",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("proofai/Academic-Proofreader", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("proofai/Academic-Proofreader"),
...
```bash
# Clone the skill
skillshub clone proofai/Academic-Proofreader
...
**Built with ❤️ by [proofai](https://skillshub.dev/proofai) on [SkillsHub](https://skillshub.dev)**
