...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Computer%20Vision-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Builds image classification pipelines with transfer learning, data augmentation, and model evaluation

## Overview

**Image Classification Pipeline** is a production-ready workflow skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install classimgai/Image-Classification-Pipeline

# Or install via pip
pip install skillshub-image-classification-pipeline

# Or install via npm
npm install @skillshub/image-classification-pipeline
```
...
skill = load_skill("classimgai/Image-Classification-Pipeline")
...
```json
{
  "skill": "classimgai/Image-Classification-Pipeline",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("classimgai/Image-Classification-Pipeline", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("classimgai/Image-Classification-Pipeline"),
...
```bash
# Clone the skill
skillshub clone classimgai/Image-Classification-Pipeline
...
**Built with ❤️ by [classimgai](https://skillshub.dev/classimgai) on [SkillsHub](https://skillshub.dev)**
