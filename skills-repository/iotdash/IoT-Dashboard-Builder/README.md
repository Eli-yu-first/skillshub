...
**IoT Dashboard Builder** is a production-ready workflow skill designed for IoT & Embedded workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install iotdash/IoT-Dashboard-Builder

# Or install via pip
pip install skillshub-iot-dashboard-builder

# Or install via npm
npm install @skillshub/iot-dashboard-builder
```
...
skill = load_skill("iotdash/IoT-Dashboard-Builder")
...
```json
{
  "skill": "iotdash/IoT-Dashboard-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("iotdash/IoT-Dashboard-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("iotdash/IoT-Dashboard-Builder"),
...
```bash
# Clone the skill
skillshub clone iotdash/IoT-Dashboard-Builder
cd IoT-Dashboard-Builder
...
**Built with ❤️ by [iotdash](https://skillshub.dev/iotdash) on [SkillsHub](https://skillshub.dev)**
