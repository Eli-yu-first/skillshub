...
**Mobile API Client Generator** is a production-ready tool skill designed for App Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install apicraft/Mobile-API-Client-Generator

# Or install via pip
pip install skillshub-mobile-api-client-generator

# Or install via npm
npm install @skillshub/mobile-api-client-generator
```
...
skill = load_skill("apicraft/Mobile-API-Client-Generator")
...
```json
{
  "skill": "apicraft/Mobile-API-Client-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("apicraft/Mobile-API-Client-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("apicraft/Mobile-API-Client-Generator"),
...
```bash
# Clone the skill
skillshub clone apicraft/Mobile-API-Client-Generator
cd Mobile-API-Client-Generator
...
**Built with ❤️ by [apicraft](https://skillshub.dev/apicraft) on [SkillsHub](https://skillshub.dev)**
