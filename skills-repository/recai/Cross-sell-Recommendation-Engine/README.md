...
**Cross-sell Recommendation Engine** is a production-ready agent skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install recai/Cross-sell-Recommendation-Engine

# Or install via pip
pip install skillshub-cross-sell-recommendation-engine

# Or install via npm
npm install @skillshub/cross-sell-recommendation-engine
```
...
skill = load_skill("recai/Cross-sell-Recommendation-Engine")
...
```json
{
  "skill": "recai/Cross-sell-Recommendation-Engine",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("recai/Cross-sell-Recommendation-Engine", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("recai/Cross-sell-Recommendation-Engine"),
...
```bash
# Clone the skill
skillshub clone recai/Cross-sell-Recommendation-Engine
cd Cross-sell-Recommendation-Engine
...
**Built with ❤️ by [recai](https://skillshub.dev/recai) on [SkillsHub](https://skillshub.dev)**
