...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Sustainability-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generates ESG reports with environmental metrics, social impact data, and governance compliance

## Overview

**ESG Report Generator** is a production-ready template skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install esgai/ESG-Report-Generator

# Or install via pip
pip install skillshub-esg-report-generator

# Or install via npm
npm install @skillshub/esg-report-generator
```
...
skill = load_skill("esgai/ESG-Report-Generator")
...
```json
{
  "skill": "esgai/ESG-Report-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("esgai/ESG-Report-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("esgai/ESG-Report-Generator"),
...
```bash
# Clone the skill
skillshub clone esgai/ESG-Report-Generator
...
**Built with ❤️ by [esgai](https://skillshub.dev/esgai) on [SkillsHub](https://skillshub.dev)**
