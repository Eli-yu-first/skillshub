...
> Composes professional emails with appropriate tone, structure, and follow-up suggestions

## Overview

**Email Composer Pro** is a production-ready prompt skill designed for Office Productivity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install mailcraft/Email-Composer-Pro

# Or add to your agent configuration
skillshub agent add-skill mailcraft/Email-Composer-Pro
```
...
skill = load_skill("mailcraft/Email-Composer-Pro")
...
```json
{
  "skill": "mailcraft/Email-Composer-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("mailcraft/Email-Composer-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("mailcraft/Email-Composer-Pro"),
...
```bash
# Clone the skill
skillshub clone mailcraft/Email-Composer-Pro
cd Email-Composer-Pro
...
**Built with ❤️ by [mailcraft](https://skillshub.dev/mailcraft) on [SkillsHub](https://skillshub.dev)**
