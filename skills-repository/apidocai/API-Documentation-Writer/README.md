...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-API%20Development-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes comprehensive API documentation with examples, error codes, and integration guides

## Overview

**API Documentation Writer** is a production-ready prompt skill designed for API Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install apidocai/API-Documentation-Writer

# Or add to your agent configuration
skillshub agent add-skill apidocai/API-Documentation-Writer
```
...
skill = load_skill("apidocai/API-Documentation-Writer")
...
```json
{
  "skill": "apidocai/API-Documentation-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("apidocai/API-Documentation-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("apidocai/API-Documentation-Writer"),
...
```bash
# Clone the skill
skillshub clone apidocai/API-Documentation-Writer
cd API-Documentation-Writer
...
**Built with ❤️ by [apidocai](https://skillshub.dev/apidocai) on [SkillsHub](https://skillshub.dev)**
