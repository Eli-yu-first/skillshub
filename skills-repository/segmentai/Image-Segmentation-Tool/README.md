...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Computer%20Vision-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Performs semantic and instance segmentation with SAM, Mask R-CNN, and custom training support

## Overview

**Image Segmentation Tool** is a production-ready tool skill designed for Computer Vision workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install segmentai/Image-Segmentation-Tool

# Or install via pip
pip install skillshub-image-segmentation-tool

# Or install via npm
npm install @skillshub/image-segmentation-tool
```
...
skill = load_skill("segmentai/Image-Segmentation-Tool")
...
```json
{
  "skill": "segmentai/Image-Segmentation-Tool",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("segmentai/Image-Segmentation-Tool", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("segmentai/Image-Segmentation-Tool"),
...
```bash
# Clone the skill
skillshub clone segmentai/Image-Segmentation-Tool
...
**Built with ❤️ by [segmentai](https://skillshub.dev/segmentai) on [SkillsHub](https://skillshub.dev)**
