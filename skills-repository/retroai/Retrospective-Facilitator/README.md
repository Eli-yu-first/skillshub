...
**Retrospective Facilitator** is a production-ready agent skill designed for Project Management workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install retroai/Retrospective-Facilitator

# Or install via pip
pip install skillshub-retrospective-facilitator

# Or install via npm
npm install @skillshub/retrospective-facilitator
```
...
skill = load_skill("retroai/Retrospective-Facilitator")
...
```json
{
  "skill": "retroai/Retrospective-Facilitator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("retroai/Retrospective-Facilitator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("retroai/Retrospective-Facilitator"),
...
```bash
# Clone the skill
skillshub clone retroai/Retrospective-Facilitator
cd Retrospective-Facilitator
...
**Built with ❤️ by [retroai](https://skillshub.dev/retroai) on [SkillsHub](https://skillshub.dev)**
