...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Language%20Learning-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Tutors reading comprehension with graded texts, comprehension questions, and vocabulary extraction

## Overview

**Reading Comprehension Tutor** is a production-ready agent skill designed for Language Learning workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install readai/Reading-Comprehension-Tutor

# Or install via pip
pip install skillshub-reading-comprehension-tutor

# Or install via npm
npm install @skillshub/reading-comprehension-tutor
```
...
skill = load_skill("readai/Reading-Comprehension-Tutor")
...
```json
{
  "skill": "readai/Reading-Comprehension-Tutor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("readai/Reading-Comprehension-Tutor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("readai/Reading-Comprehension-Tutor"),
...
```bash
# Clone the skill
skillshub clone readai/Reading-Comprehension-Tutor
cd Reading-Comprehension-Tutor
...
**Built with ❤️ by [readai](https://skillshub.dev/readai) on [SkillsHub](https://skillshub.dev)**
