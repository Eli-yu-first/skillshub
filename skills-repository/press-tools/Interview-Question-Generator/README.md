...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Journalism%20%26%20Media-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generate insightful interview questions based on subject background and story angle

## Overview

**Interview Question Generator** is a production-ready prompt skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install press-tools/Interview-Question-Generator

# Or add to your agent configuration
skillshub agent add-skill press-tools/Interview-Question-Generator
```
...
skill = load_skill("press-tools/Interview-Question-Generator")
...
```json
{
  "skill": "press-tools/Interview-Question-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("press-tools/Interview-Question-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("press-tools/Interview-Question-Generator"),
...
```bash
# Clone the skill
skillshub clone press-tools/Interview-Question-Generator
...
**Built with ❤️ by [press-tools](https://skillshub.dev/press-tools) on [SkillsHub](https://skillshub.dev)**
