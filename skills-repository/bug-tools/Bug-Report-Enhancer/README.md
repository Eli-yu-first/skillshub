...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Quality%20Assurance-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Enhance bug reports with reproduction steps, environment details, and severity classification

## Overview

**Bug Report Enhancer** is a production-ready prompt skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bug-tools/Bug-Report-Enhancer

# Or add to your agent configuration
skillshub agent add-skill bug-tools/Bug-Report-Enhancer
```
...
skill = load_skill("bug-tools/Bug-Report-Enhancer")
...
```json
{
  "skill": "bug-tools/Bug-Report-Enhancer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bug-tools/Bug-Report-Enhancer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bug-tools/Bug-Report-Enhancer"),
...
```bash
# Clone the skill
skillshub clone bug-tools/Bug-Report-Enhancer
...
**Built with ❤️ by [bug-tools](https://skillshub.dev/bug-tools) on [SkillsHub](https://skillshub.dev)**
