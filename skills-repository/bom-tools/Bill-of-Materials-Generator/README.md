...
**Bill of Materials Generator** is a production-ready tool skill designed for Manufacturing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bom-tools/Bill-of-Materials-Generator

# Or install via pip
pip install skillshub-bill-of-materials-generator

# Or install via npm
npm install @skillshub/bill-of-materials-generator
```
...
skill = load_skill("bom-tools/Bill-of-Materials-Generator")
...
```json
{
  "skill": "bom-tools/Bill-of-Materials-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bom-tools/Bill-of-Materials-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bom-tools/Bill-of-Materials-Generator"),
...
```bash
# Clone the skill
skillshub clone bom-tools/Bill-of-Materials-Generator
cd Bill-of-Materials-Generator
...
**Built with ❤️ by [bom-tools](https://skillshub.dev/bom-tools) on [SkillsHub](https://skillshub.dev)**
