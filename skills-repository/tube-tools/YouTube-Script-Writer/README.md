...
**YouTube Script Writer** is a production-ready prompt skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tube-tools/YouTube-Script-Writer

# Or add to your agent configuration
skillshub agent add-skill tube-tools/YouTube-Script-Writer
```
...
skill = load_skill("tube-tools/YouTube-Script-Writer")
...
```json
{
  "skill": "tube-tools/YouTube-Script-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tube-tools/YouTube-Script-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tube-tools/YouTube-Script-Writer"),
...
```bash
# Clone the skill
skillshub clone tube-tools/YouTube-Script-Writer
...
**Built with ❤️ by [tube-tools](https://skillshub.dev/tube-tools) on [SkillsHub](https://skillshub.dev)**
