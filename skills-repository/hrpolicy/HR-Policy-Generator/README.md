...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Human%20Resources-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generates HR policies for remote work, PTO, harassment prevention, and workplace safety compliance

## Overview

**HR Policy Generator** is a production-ready template skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install hrpolicy/HR-Policy-Generator

# Or install via pip
pip install skillshub-hr-policy-generator

# Or install via npm
npm install @skillshub/hr-policy-generator
```
...
skill = load_skill("hrpolicy/HR-Policy-Generator")
...
```json
{
  "skill": "hrpolicy/HR-Policy-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("hrpolicy/HR-Policy-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("hrpolicy/HR-Policy-Generator"),
...
```bash
# Clone the skill
skillshub clone hrpolicy/HR-Policy-Generator
...
**Built with ❤️ by [hrpolicy](https://skillshub.dev/hrpolicy) on [SkillsHub](https://skillshub.dev)**
