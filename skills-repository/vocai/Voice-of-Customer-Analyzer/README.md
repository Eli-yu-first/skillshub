...
**Voice of Customer Analyzer** is a production-ready agent skill designed for Customer Service workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install vocai/Voice-of-Customer-Analyzer

# Or install via pip
pip install skillshub-voice-of-customer-analyzer

# Or install via npm
npm install @skillshub/voice-of-customer-analyzer
```
...
skill = load_skill("vocai/Voice-of-Customer-Analyzer")
...
```json
{
  "skill": "vocai/Voice-of-Customer-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("vocai/Voice-of-Customer-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("vocai/Voice-of-Customer-Analyzer"),
...
```bash
# Clone the skill
skillshub clone vocai/Voice-of-Customer-Analyzer
cd Voice-of-Customer-Analyzer
...
**Built with ❤️ by [vocai](https://skillshub.dev/vocai) on [SkillsHub](https://skillshub.dev)**
