...
> Translate content across 50+ languages with context-aware quality and tone preservation

## Overview

**Multi-Language Translator Pro** is a production-ready agent skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install lingua-ai/Multi-Language-Translator-Pro

# Or install via pip
pip install skillshub-multi-language-translator-pro

# Or install via npm
npm install @skillshub/multi-language-translator-pro
```
...
skill = load_skill("lingua-ai/Multi-Language-Translator-Pro")
...
```json
{
  "skill": "lingua-ai/Multi-Language-Translator-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("lingua-ai/Multi-Language-Translator-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("lingua-ai/Multi-Language-Translator-Pro"),
...
```bash
# Clone the skill
skillshub clone lingua-ai/Multi-Language-Translator-Pro
cd Multi-Language-Translator-Pro
...
**Built with ❤️ by [lingua-ai](https://skillshub.dev/lingua-ai) on [SkillsHub](https://skillshub.dev)**
