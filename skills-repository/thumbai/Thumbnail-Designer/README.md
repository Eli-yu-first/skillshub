...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Video%20Production-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Designs click-worthy YouTube thumbnails with text overlay, color psychology, and A/B testing variants

## Overview

**Thumbnail Designer** is a production-ready prompt skill designed for Video Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install thumbai/Thumbnail-Designer

# Or add to your agent configuration
skillshub agent add-skill thumbai/Thumbnail-Designer
```
...
skill = load_skill("thumbai/Thumbnail-Designer")
...
```json
{
  "skill": "thumbai/Thumbnail-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("thumbai/Thumbnail-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("thumbai/Thumbnail-Designer"),
...
```bash
# Clone the skill
skillshub clone thumbai/Thumbnail-Designer
cd Thumbnail-Designer
...
**Built with ❤️ by [thumbai](https://skillshub.dev/thumbai) on [SkillsHub](https://skillshub.dev)**
