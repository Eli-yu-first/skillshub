# Procurement Document Agent

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Official%20Document%20Writing-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Generates procurement documents including RFPs, RFQs, bid evaluations, and vendor comparison matrices

## Overview

**Procurement Document Agent** is a production-ready agent skill designed for Official Document Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install procureai/Procurement-Document-Agent

# Or install via pip
pip install skillshub-procurement-document-agent

# Or install via npm
npm install @skillshub/procurement-document-agent
```
...
skill = load_skill("procureai/Procurement-Document-Agent")
...
```json
{
  "skill": "procureai/Procurement-Document-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("procureai/Procurement-Document-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("procureai/Procurement-Document-Agent"),
...
```bash
# Clone the skill
skillshub clone procureai/Procurement-Document-Agent
cd Procurement-Document-Agent
...
**Built with ❤️ by [procureai](https://skillshub.dev/procureai) on [SkillsHub](https://skillshub.dev)**
