...
**Bookkeeping Categorizer** is a production-ready tool skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bookkeepai/Bookkeeping-Categorizer

# Or install via pip
pip install skillshub-bookkeeping-categorizer

# Or install via npm
npm install @skillshub/bookkeeping-categorizer
```
...
skill = load_skill("bookkeepai/Bookkeeping-Categorizer")
...
```json
{
  "skill": "bookkeepai/Bookkeeping-Categorizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bookkeepai/Bookkeeping-Categorizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bookkeepai/Bookkeeping-Categorizer"),
...
```bash
# Clone the skill
skillshub clone bookkeepai/Bookkeeping-Categorizer
cd Bookkeeping-Categorizer
...
**Built with ❤️ by [bookkeepai](https://skillshub.dev/bookkeepai) on [SkillsHub](https://skillshub.dev)**
