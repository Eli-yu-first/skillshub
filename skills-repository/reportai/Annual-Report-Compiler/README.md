# Annual Report Compiler

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Official%20Document%20Writing-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Compiles annual reports with data aggregation, chart generation, and narrative sections

## Overview

**Annual Report Compiler** is a production-ready workflow skill designed for Official Document Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install reportai/Annual-Report-Compiler

# Or install via pip
pip install skillshub-annual-report-compiler

# Or install via npm
npm install @skillshub/annual-report-compiler
```
...
skill = load_skill("reportai/Annual-Report-Compiler")
...
```json
{
  "skill": "reportai/Annual-Report-Compiler",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("reportai/Annual-Report-Compiler", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("reportai/Annual-Report-Compiler"),
...
```bash
# Clone the skill
skillshub clone reportai/Annual-Report-Compiler
cd Annual-Report-Compiler
...
**Built with ❤️ by [reportai](https://skillshub.dev/reportai) on [SkillsHub](https://skillshub.dev)**
