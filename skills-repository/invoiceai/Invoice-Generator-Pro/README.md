...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Finance%20%26%20Accounting-coral) ![Type](https://img.shields.io/badge/type-template-teal)

> Generates professional invoices with customizable templates, tax calculations, and payment terms

## Overview

**Invoice Generator Pro** is a production-ready template skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install invoiceai/Invoice-Generator-Pro

# Or install via pip
pip install skillshub-invoice-generator-pro

# Or install via npm
npm install @skillshub/invoice-generator-pro
```
...
skill = load_skill("invoiceai/Invoice-Generator-Pro")
...
```json
{
  "skill": "invoiceai/Invoice-Generator-Pro",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("invoiceai/Invoice-Generator-Pro", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("invoiceai/Invoice-Generator-Pro"),
...
```bash
# Clone the skill
skillshub clone invoiceai/Invoice-Generator-Pro
...
**Built with ❤️ by [invoiceai](https://skillshub.dev/invoiceai) on [SkillsHub](https://skillshub.dev)**
