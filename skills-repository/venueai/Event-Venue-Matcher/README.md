...
**Event Venue Matcher** is a production-ready agent skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install venueai/Event-Venue-Matcher

# Or install via pip
pip install skillshub-event-venue-matcher

# Or install via npm
npm install @skillshub/event-venue-matcher
```
...
skill = load_skill("venueai/Event-Venue-Matcher")
...
```json
{
  "skill": "venueai/Event-Venue-Matcher",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("venueai/Event-Venue-Matcher", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("venueai/Event-Venue-Matcher"),
...
```bash
# Clone the skill
skillshub clone venueai/Event-Venue-Matcher
cd Event-Venue-Matcher
...
**Built with ❤️ by [venueai](https://skillshub.dev/venueai) on [SkillsHub](https://skillshub.dev)**
