...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Office%20Productivity-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Automates Google Docs, Sheets, and Slides workflows with Apps Script generation and API integration

## Overview

**Google Workspace Integrator** is a production-ready rpa skill designed for Office Productivity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install gworkbot/Google-Workspace-Integrator

# Or install via pip
pip install skillshub-google-workspace-integrator

# Or install via npm
npm install @skillshub/google-workspace-integrator
```
...
skill = load_skill("gworkbot/Google-Workspace-Integrator")
...
```json
{
  "skill": "gworkbot/Google-Workspace-Integrator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("gworkbot/Google-Workspace-Integrator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("gworkbot/Google-Workspace-Integrator"),
...
```bash
# Clone the skill
skillshub clone gworkbot/Google-Workspace-Integrator
cd Google-Workspace-Integrator
...
**Built with ❤️ by [gworkbot](https://skillshub.dev/gworkbot) on [SkillsHub](https://skillshub.dev)**
