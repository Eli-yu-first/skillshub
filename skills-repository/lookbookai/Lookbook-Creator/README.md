...
**Lookbook Creator** is a production-ready workflow skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install lookbookai/Lookbook-Creator

# Or install via pip
pip install skillshub-lookbook-creator

# Or install via npm
npm install @skillshub/lookbook-creator
```
...
skill = load_skill("lookbookai/Lookbook-Creator")
...
```json
{
  "skill": "lookbookai/Lookbook-Creator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("lookbookai/Lookbook-Creator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("lookbookai/Lookbook-Creator"),
...
```bash
# Clone the skill
skillshub clone lookbookai/Lookbook-Creator
cd Lookbook-Creator
...
**Built with ❤️ by [lookbookai](https://skillshub.dev/lookbookai) on [SkillsHub](https://skillshub.dev)**
