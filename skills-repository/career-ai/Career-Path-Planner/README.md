...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Personal%20Development-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Map career development paths with skill gap analysis and learning recommendations

## Overview

**Career Path Planner** is a production-ready workflow skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install career-ai/Career-Path-Planner

# Or install via pip
pip install skillshub-career-path-planner

# Or install via npm
npm install @skillshub/career-path-planner
```
...
skill = load_skill("career-ai/Career-Path-Planner")
...
```json
{
  "skill": "career-ai/Career-Path-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("career-ai/Career-Path-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("career-ai/Career-Path-Planner"),
...
```bash
# Clone the skill
skillshub clone career-ai/Career-Path-Planner
...
**Built with ❤️ by [career-ai](https://skillshub.dev/career-ai) on [SkillsHub](https://skillshub.dev)**
