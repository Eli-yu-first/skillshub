...
**Product Description Writer** is a production-ready prompt skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install prodai/Product-Description-Writer

# Or add to your agent configuration
skillshub agent add-skill prodai/Product-Description-Writer
```
...
skill = load_skill("prodai/Product-Description-Writer")
...
```json
{
  "skill": "prodai/Product-Description-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("prodai/Product-Description-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("prodai/Product-Description-Writer"),
...
```bash
# Clone the skill
skillshub clone prodai/Product-Description-Writer
...
**Built with ❤️ by [prodai](https://skillshub.dev/prodai) on [SkillsHub](https://skillshub.dev)**
