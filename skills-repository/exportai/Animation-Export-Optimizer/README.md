...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Animation%20Production-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Optimizes animation exports for different platforms with codec selection, frame rate, and quality settings

## Overview

**Animation Export Optimizer** is a production-ready tool skill designed for Animation Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install exportai/Animation-Export-Optimizer

# Or install via pip
pip install skillshub-animation-export-optimizer

# Or install via npm
npm install @skillshub/animation-export-optimizer
```
...
skill = load_skill("exportai/Animation-Export-Optimizer")
...
```json
{
  "skill": "exportai/Animation-Export-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("exportai/Animation-Export-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("exportai/Animation-Export-Optimizer"),
...
```bash
# Clone the skill
skillshub clone exportai/Animation-Export-Optimizer
cd Animation-Export-Optimizer
...
**Built with ❤️ by [exportai](https://skillshub.dev/exportai) on [SkillsHub](https://skillshub.dev)**
