...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Healthcare%20%26%20Medical-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Audit healthcare systems and documents for HIPAA compliance violations

## Overview

**HIPAA Compliance Checker** is a production-ready rpa skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install compliance-med/HIPAA-Compliance-Checker

# Or install via pip
pip install skillshub-hipaa-compliance-checker

# Or install via npm
npm install @skillshub/hipaa-compliance-checker
```
...
skill = load_skill("compliance-med/HIPAA-Compliance-Checker")
...
```json
{
  "skill": "compliance-med/HIPAA-Compliance-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("compliance-med/HIPAA-Compliance-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("compliance-med/HIPAA-Compliance-Checker"),
...
```bash
# Clone the skill
skillshub clone compliance-med/HIPAA-Compliance-Checker
...
**Built with ❤️ by [compliance-med](https://skillshub.dev/compliance-med) on [SkillsHub](https://skillshub.dev)**
