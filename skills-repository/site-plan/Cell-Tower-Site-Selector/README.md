...
**Cell Tower Site Selector** is a production-ready agent skill designed for Telecommunications workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install site-plan/Cell-Tower-Site-Selector

# Or install via pip
pip install skillshub-cell-tower-site-selector

# Or install via npm
npm install @skillshub/cell-tower-site-selector
```
...
skill = load_skill("site-plan/Cell-Tower-Site-Selector")
...
```json
{
  "skill": "site-plan/Cell-Tower-Site-Selector",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("site-plan/Cell-Tower-Site-Selector", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("site-plan/Cell-Tower-Site-Selector"),
...
```bash
# Clone the skill
skillshub clone site-plan/Cell-Tower-Site-Selector
cd Cell-Tower-Site-Selector
...
**Built with ❤️ by [site-plan](https://skillshub.dev/site-plan) on [SkillsHub](https://skillshub.dev)**
