...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Supply%20Chain%20%26%20Logistics-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Generate customs declarations, commercial invoices, and trade compliance documents

## Overview

**Customs Documentation Agent** is a production-ready rpa skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install trade-tools/Customs-Documentation-Agent

# Or install via pip
pip install skillshub-customs-documentation-agent

# Or install via npm
npm install @skillshub/customs-documentation-agent
```
...
skill = load_skill("trade-tools/Customs-Documentation-Agent")
...
```json
{
  "skill": "trade-tools/Customs-Documentation-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("trade-tools/Customs-Documentation-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("trade-tools/Customs-Documentation-Agent"),
...
```bash
# Clone the skill
skillshub clone trade-tools/Customs-Documentation-Agent
cd Customs-Documentation-Agent
...
**Built with ❤️ by [trade-tools](https://skillshub.dev/trade-tools) on [SkillsHub](https://skillshub.dev)**
