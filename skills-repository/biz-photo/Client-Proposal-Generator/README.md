...
> Generate professional photography client proposals with pricing packages and terms

## Overview

**Client Proposal Generator** is a production-ready template skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install biz-photo/Client-Proposal-Generator

# Or install via pip
pip install skillshub-client-proposal-generator

# Or install via npm
npm install @skillshub/client-proposal-generator
```
...
skill = load_skill("biz-photo/Client-Proposal-Generator")
...
```json
{
  "skill": "biz-photo/Client-Proposal-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("biz-photo/Client-Proposal-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("biz-photo/Client-Proposal-Generator"),
...
```bash
# Clone the skill
skillshub clone biz-photo/Client-Proposal-Generator
...
**Built with ❤️ by [biz-photo](https://skillshub.dev/biz-photo) on [SkillsHub](https://skillshub.dev)**
