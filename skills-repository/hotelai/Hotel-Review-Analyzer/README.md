...
> Analyzes hotel reviews with sentiment scoring, aspect extraction, and comparative ranking

## Overview

**Hotel Review Analyzer** is a production-ready agent skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install hotelai/Hotel-Review-Analyzer

# Or install via pip
pip install skillshub-hotel-review-analyzer

# Or install via npm
npm install @skillshub/hotel-review-analyzer
```
...
skill = load_skill("hotelai/Hotel-Review-Analyzer")
...
```json
{
  "skill": "hotelai/Hotel-Review-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("hotelai/Hotel-Review-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("hotelai/Hotel-Review-Analyzer"),
...
```bash
# Clone the skill
skillshub clone hotelai/Hotel-Review-Analyzer
...
**Built with ❤️ by [hotelai](https://skillshub.dev/hotelai) on [SkillsHub](https://skillshub.dev)**
