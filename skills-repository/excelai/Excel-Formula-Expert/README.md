...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Office%20Productivity-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generates complex Excel formulas, pivot table configurations, and VBA macros from natural language requests

## Overview

**Excel Formula Expert** is a production-ready prompt skill designed for Office Productivity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install excelai/Excel-Formula-Expert

# Or add to your agent configuration
skillshub agent add-skill excelai/Excel-Formula-Expert
```
...
skill = load_skill("excelai/Excel-Formula-Expert")
...
```json
{
  "skill": "excelai/Excel-Formula-Expert",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("excelai/Excel-Formula-Expert", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("excelai/Excel-Formula-Expert"),
...
```bash
# Clone the skill
skillshub clone excelai/Excel-Formula-Expert
cd Excel-Formula-Expert
...
**Built with ❤️ by [excelai](https://skillshub.dev/excelai) on [SkillsHub](https://skillshub.dev)**
