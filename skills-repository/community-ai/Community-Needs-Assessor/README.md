...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Non-profit%20%26%20Social%20Impact-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Conduct community needs assessments using survey design, data collection, and analysis

## Overview

**Community Needs Assessor** is a production-ready agent skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install community-ai/Community-Needs-Assessor

# Or install via pip
pip install skillshub-community-needs-assessor

# Or install via npm
npm install @skillshub/community-needs-assessor
```
...
skill = load_skill("community-ai/Community-Needs-Assessor")
...
```json
{
  "skill": "community-ai/Community-Needs-Assessor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("community-ai/Community-Needs-Assessor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("community-ai/Community-Needs-Assessor"),
...
```bash
# Clone the skill
skillshub clone community-ai/Community-Needs-Assessor
cd Community-Needs-Assessor
...
**Built with ❤️ by [community-ai](https://skillshub.dev/community-ai) on [SkillsHub](https://skillshub.dev)**
