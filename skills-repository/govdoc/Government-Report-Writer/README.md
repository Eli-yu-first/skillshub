...
> Drafts government reports with proper formatting, executive summaries, and policy recommendations

## Overview

**Government Report Writer** is a production-ready prompt skill designed for Official Document Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install govdoc/Government-Report-Writer

# Or add to your agent configuration
skillshub agent add-skill govdoc/Government-Report-Writer
```
...
skill = load_skill("govdoc/Government-Report-Writer")
...
```json
{
  "skill": "govdoc/Government-Report-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("govdoc/Government-Report-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("govdoc/Government-Report-Writer"),
...
```bash
# Clone the skill
skillshub clone govdoc/Government-Report-Writer
cd Government-Report-Writer
...
**Built with ❤️ by [govdoc](https://skillshub.dev/govdoc) on [SkillsHub](https://skillshub.dev)**
