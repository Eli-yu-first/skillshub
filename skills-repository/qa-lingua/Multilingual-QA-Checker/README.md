...
> Quality assurance checks for translated content including formatting, numbers, and placeholders

## Overview

**Multilingual QA Checker** is a production-ready tool skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install qa-lingua/Multilingual-QA-Checker

# Or install via pip
pip install skillshub-multilingual-qa-checker

# Or install via npm
npm install @skillshub/multilingual-qa-checker
```
...
skill = load_skill("qa-lingua/Multilingual-QA-Checker")
...
```json
{
  "skill": "qa-lingua/Multilingual-QA-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("qa-lingua/Multilingual-QA-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("qa-lingua/Multilingual-QA-Checker"),
...
```bash
# Clone the skill
skillshub clone qa-lingua/Multilingual-QA-Checker
cd Multilingual-QA-Checker
...
**Built with ❤️ by [qa-lingua](https://skillshub.dev/qa-lingua) on [SkillsHub](https://skillshub.dev)**
