...
> Analyzes climate risks for businesses with scenario modeling, adaptation strategies, and resilience planning

## Overview

**Climate Risk Analyzer** is a production-ready agent skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install climateai/Climate-Risk-Analyzer

# Or install via pip
pip install skillshub-climate-risk-analyzer

# Or install via npm
npm install @skillshub/climate-risk-analyzer
```
...
skill = load_skill("climateai/Climate-Risk-Analyzer")
...
```json
{
  "skill": "climateai/Climate-Risk-Analyzer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("climateai/Climate-Risk-Analyzer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("climateai/Climate-Risk-Analyzer"),
...
```bash
# Clone the skill
skillshub clone climateai/Climate-Risk-Analyzer
cd Climate-Risk-Analyzer
...
**Built with ❤️ by [climateai](https://skillshub.dev/climateai) on [SkillsHub](https://skillshub.dev)**
