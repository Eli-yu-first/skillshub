...
> Optimizes video titles, descriptions, tags, and chapters for maximum YouTube/TikTok discoverability

## Overview

**Video SEO Optimizer** is a production-ready agent skill designed for Video Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install vseobot/Video-SEO-Optimizer

# Or install via pip
pip install skillshub-video-seo-optimizer

# Or install via npm
npm install @skillshub/video-seo-optimizer
```
...
skill = load_skill("vseobot/Video-SEO-Optimizer")
...
```json
{
  "skill": "vseobot/Video-SEO-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("vseobot/Video-SEO-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("vseobot/Video-SEO-Optimizer"),
...
```bash
# Clone the skill
skillshub clone vseobot/Video-SEO-Optimizer
...
**Built with ❤️ by [vseobot](https://skillshub.dev/vseobot) on [SkillsHub](https://skillshub.dev)**
