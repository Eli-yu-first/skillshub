...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-NLP-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Generates diverse training data for chatbots with intent variations, entity annotations, and edge cases

## Overview

**Chatbot Training Data Generator** is a production-ready tool skill designed for NLP workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install chatdataai/Chatbot-Training-Data-Generator

# Or install via pip
pip install skillshub-chatbot-training-data-generator

# Or install via npm
npm install @skillshub/chatbot-training-data-generator
```
...
skill = load_skill("chatdataai/Chatbot-Training-Data-Generator")
...
```json
{
  "skill": "chatdataai/Chatbot-Training-Data-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("chatdataai/Chatbot-Training-Data-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("chatdataai/Chatbot-Training-Data-Generator"),
...
```bash
# Clone the skill
skillshub clone chatdataai/Chatbot-Training-Data-Generator
cd Chatbot-Training-Data-Generator
...
**Built with ❤️ by [chatdataai](https://skillshub.dev/chatdataai) on [SkillsHub](https://skillshub.dev)**
