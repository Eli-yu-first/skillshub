...
**NPC Dialogue Tree Builder** is a production-ready agent skill designed for Game Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install narrative-ai/NPC-Dialogue-Tree-Builder

# Or install via pip
pip install skillshub-npc-dialogue-tree-builder

# Or install via npm
npm install @skillshub/npc-dialogue-tree-builder
```
...
skill = load_skill("narrative-ai/NPC-Dialogue-Tree-Builder")
...
```json
{
  "skill": "narrative-ai/NPC-Dialogue-Tree-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("narrative-ai/NPC-Dialogue-Tree-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("narrative-ai/NPC-Dialogue-Tree-Builder"),
...
```bash
# Clone the skill
skillshub clone narrative-ai/NPC-Dialogue-Tree-Builder
cd NPC-Dialogue-Tree-Builder
...
**Built with ❤️ by [narrative-ai](https://skillshub.dev/narrative-ai) on [SkillsHub](https://skillshub.dev)**
