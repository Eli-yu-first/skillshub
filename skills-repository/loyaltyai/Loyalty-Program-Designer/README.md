...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Travel%20%26%20Hospitality-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Designs hospitality loyalty programs with tier structures, point systems, and reward catalogs

## Overview

**Loyalty Program Designer** is a production-ready workflow skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install loyaltyai/Loyalty-Program-Designer

# Or install via pip
pip install skillshub-loyalty-program-designer

# Or install via npm
npm install @skillshub/loyalty-program-designer
```
...
skill = load_skill("loyaltyai/Loyalty-Program-Designer")
...
```json
{
  "skill": "loyaltyai/Loyalty-Program-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("loyaltyai/Loyalty-Program-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("loyaltyai/Loyalty-Program-Designer"),
...
```bash
# Clone the skill
skillshub clone loyaltyai/Loyalty-Program-Designer
cd Loyalty-Program-Designer
...
**Built with ❤️ by [loyaltyai](https://skillshub.dev/loyaltyai) on [SkillsHub](https://skillshub.dev)**
