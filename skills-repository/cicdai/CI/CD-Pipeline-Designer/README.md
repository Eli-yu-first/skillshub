...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-DevOps%20%26%20Cloud-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Designs CI/CD pipelines for GitHub Actions, GitLab CI, or Jenkins with testing and deployment stages

## Overview

**CI/CD Pipeline Designer** is a production-ready workflow skill designed for DevOps & Cloud workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install cicdai/CI/CD-Pipeline-Designer

# Or install via pip
pip install skillshub-ci/cd-pipeline-designer

# Or install via npm
npm install @skillshub/ci/cd-pipeline-designer
```
...
skill = load_skill("cicdai/CI/CD-Pipeline-Designer")
...
```json
{
  "skill": "cicdai/CI/CD-Pipeline-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("cicdai/CI/CD-Pipeline-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("cicdai/CI/CD-Pipeline-Designer"),
...
```bash
# Clone the skill
skillshub clone cicdai/CI/CD-Pipeline-Designer
cd CI/CD-Pipeline-Designer
...
**Built with ❤️ by [cicdai](https://skillshub.dev/cicdai) on [SkillsHub](https://skillshub.dev)**
