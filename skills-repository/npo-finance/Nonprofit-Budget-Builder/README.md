...
**Nonprofit Budget Builder** is a production-ready template skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install npo-finance/Nonprofit-Budget-Builder

# Or install via pip
pip install skillshub-nonprofit-budget-builder

# Or install via npm
npm install @skillshub/nonprofit-budget-builder
```
...
skill = load_skill("npo-finance/Nonprofit-Budget-Builder")
...
```json
{
  "skill": "npo-finance/Nonprofit-Budget-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("npo-finance/Nonprofit-Budget-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("npo-finance/Nonprofit-Budget-Builder"),
...
```bash
# Clone the skill
skillshub clone npo-finance/Nonprofit-Budget-Builder
cd Nonprofit-Budget-Builder
...
**Built with ❤️ by [npo-finance](https://skillshub.dev/npo-finance) on [SkillsHub](https://skillshub.dev)**
