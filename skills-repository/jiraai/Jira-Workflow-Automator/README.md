...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Project%20Management-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Automates Jira workflows with ticket creation, status transitions, and custom field updates

## Overview

**Jira Workflow Automator** is a production-ready rpa skill designed for Project Management workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install jiraai/Jira-Workflow-Automator

# Or install via pip
pip install skillshub-jira-workflow-automator

# Or install via npm
npm install @skillshub/jira-workflow-automator
```
...
skill = load_skill("jiraai/Jira-Workflow-Automator")
...
```json
{
  "skill": "jiraai/Jira-Workflow-Automator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("jiraai/Jira-Workflow-Automator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("jiraai/Jira-Workflow-Automator"),
...
```bash
# Clone the skill
skillshub clone jiraai/Jira-Workflow-Automator
cd Jira-Workflow-Automator
...
**Built with ❤️ by [jiraai](https://skillshub.dev/jiraai) on [SkillsHub](https://skillshub.dev)**
