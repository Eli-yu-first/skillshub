...
**Gym Equipment Recommender** is a production-ready tool skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install gymequipai/Gym-Equipment-Recommender

# Or install via pip
pip install skillshub-gym-equipment-recommender

# Or install via npm
npm install @skillshub/gym-equipment-recommender
```
...
skill = load_skill("gymequipai/Gym-Equipment-Recommender")
...
```json
{
  "skill": "gymequipai/Gym-Equipment-Recommender",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("gymequipai/Gym-Equipment-Recommender", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("gymequipai/Gym-Equipment-Recommender"),
...
```bash
# Clone the skill
skillshub clone gymequipai/Gym-Equipment-Recommender
cd Gym-Equipment-Recommender
...
**Built with ❤️ by [gymequipai](https://skillshub.dev/gymequipai) on [SkillsHub](https://skillshub.dev)**
