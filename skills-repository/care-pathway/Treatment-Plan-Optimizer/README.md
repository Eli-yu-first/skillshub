...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Healthcare%20%26%20Medical-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Optimize treatment plans based on evidence-based guidelines and patient history

## Overview

**Treatment Plan Optimizer** is a production-ready workflow skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install care-pathway/Treatment-Plan-Optimizer

# Or install via pip
pip install skillshub-treatment-plan-optimizer

# Or install via npm
npm install @skillshub/treatment-plan-optimizer
```
...
skill = load_skill("care-pathway/Treatment-Plan-Optimizer")
...
```json
{
  "skill": "care-pathway/Treatment-Plan-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("care-pathway/Treatment-Plan-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("care-pathway/Treatment-Plan-Optimizer"),
...
```bash
# Clone the skill
skillshub clone care-pathway/Treatment-Plan-Optimizer
cd Treatment-Plan-Optimizer
...
**Built with ❤️ by [care-pathway](https://skillshub.dev/care-pathway) on [SkillsHub](https://skillshub.dev)**
