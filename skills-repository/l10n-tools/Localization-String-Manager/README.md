...
> Manage i18n string files, detect missing translations, and maintain consistency across locales

## Overview

**Localization String Manager** is a production-ready tool skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install l10n-tools/Localization-String-Manager

# Or install via pip
pip install skillshub-localization-string-manager

# Or install via npm
npm install @skillshub/localization-string-manager
```
...
skill = load_skill("l10n-tools/Localization-String-Manager")
...
```json
{
  "skill": "l10n-tools/Localization-String-Manager",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("l10n-tools/Localization-String-Manager", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("l10n-tools/Localization-String-Manager"),
...
```bash
# Clone the skill
skillshub clone l10n-tools/Localization-String-Manager
cd Localization-String-Manager
...
**Built with ❤️ by [l10n-tools](https://skillshub.dev/l10n-tools) on [SkillsHub](https://skillshub.dev)**
