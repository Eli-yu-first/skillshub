...
**Unity Script Generator** is a production-ready tool skill designed for Game Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install unity-ai/Unity-Script-Generator

# Or install via pip
pip install skillshub-unity-script-generator

# Or install via npm
npm install @skillshub/unity-script-generator
```
...
skill = load_skill("unity-ai/Unity-Script-Generator")
...
```json
{
  "skill": "unity-ai/Unity-Script-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("unity-ai/Unity-Script-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("unity-ai/Unity-Script-Generator"),
...
```bash
# Clone the skill
skillshub clone unity-ai/Unity-Script-Generator
cd Unity-Script-Generator
...
**Built with ❤️ by [unity-ai](https://skillshub.dev/unity-ai) on [SkillsHub](https://skillshub.dev)**
