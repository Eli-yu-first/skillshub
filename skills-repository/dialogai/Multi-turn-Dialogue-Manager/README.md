...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-NLP-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Manages multi-turn dialogues with context tracking, slot filling, and conversation state management

## Overview

**Multi-turn Dialogue Manager** is a production-ready agent skill designed for NLP workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install dialogai/Multi-turn-Dialogue-Manager

# Or install via pip
pip install skillshub-multi-turn-dialogue-manager

# Or install via npm
npm install @skillshub/multi-turn-dialogue-manager
```
...
skill = load_skill("dialogai/Multi-turn-Dialogue-Manager")
...
```json
{
  "skill": "dialogai/Multi-turn-Dialogue-Manager",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("dialogai/Multi-turn-Dialogue-Manager", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("dialogai/Multi-turn-Dialogue-Manager"),
...
```bash
# Clone the skill
skillshub clone dialogai/Multi-turn-Dialogue-Manager
cd Multi-turn-Dialogue-Manager
...
**Built with ❤️ by [dialogai](https://skillshub.dev/dialogai) on [SkillsHub](https://skillshub.dev)**
