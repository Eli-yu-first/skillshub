# Telemedicine Script Builder

![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-General-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Creates telemedicine consultation scripts with symptom assessment, triage protocols, and follow-up plans

## Overview

**Telemedicine Script Builder** is a production-ready prompt skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install telemedai/Telemedicine-Script-Builder

# Or add to your agent configuration
skillshub agent add-skill telemedai/Telemedicine-Script-Builder
```
...
skill = load_skill("telemedai/Telemedicine-Script-Builder")
...
```json
{
  "skill": "telemedai/Telemedicine-Script-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("telemedai/Telemedicine-Script-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("telemedai/Telemedicine-Script-Builder"),
...
```bash
# Clone the skill
skillshub clone telemedai/Telemedicine-Script-Builder
cd Telemedicine-Script-Builder
...
**Built with ❤️ by [telemedai](https://skillshub.dev/telemedai) on [SkillsHub](https://skillshub.dev)**
