...
**Annual Report Designer** is a production-ready template skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install report-npo/Annual-Report-Designer

# Or install via pip
pip install skillshub-annual-report-designer

# Or install via npm
npm install @skillshub/annual-report-designer
```
...
skill = load_skill("report-npo/Annual-Report-Designer")
...
```json
{
  "skill": "report-npo/Annual-Report-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("report-npo/Annual-Report-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("report-npo/Annual-Report-Designer"),
...
```bash
# Clone the skill
skillshub clone report-npo/Annual-Report-Designer
cd Annual-Report-Designer
...
**Built with ❤️ by [report-npo](https://skillshub.dev/report-npo) on [SkillsHub](https://skillshub.dev)**
