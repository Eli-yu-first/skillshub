...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Translation%20%26%20Localization-coral) ![Type](https://img.shields.io/badge/type-rpa-teal)

> Manage translation memory databases for reuse, consistency, and cost reduction

## Overview

**Translation Memory Manager** is a production-ready rpa skill designed for Translation & Localization workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tm-tools/Translation-Memory-Manager

# Or install via pip
pip install skillshub-translation-memory-manager

# Or install via npm
npm install @skillshub/translation-memory-manager
```
...
skill = load_skill("tm-tools/Translation-Memory-Manager")
...
```json
{
  "skill": "tm-tools/Translation-Memory-Manager",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tm-tools/Translation-Memory-Manager", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tm-tools/Translation-Memory-Manager"),
...
```bash
# Clone the skill
skillshub clone tm-tools/Translation-Memory-Manager
cd Translation-Memory-Manager
...
**Built with ❤️ by [tm-tools](https://skillshub.dev/tm-tools) on [SkillsHub](https://skillshub.dev)**
