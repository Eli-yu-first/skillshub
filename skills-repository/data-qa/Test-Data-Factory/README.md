...
**Test Data Factory** is a production-ready tool skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install data-qa/Test-Data-Factory

# Or install via pip
pip install skillshub-test-data-factory

# Or install via npm
npm install @skillshub/test-data-factory
```
...
skill = load_skill("data-qa/Test-Data-Factory")
...
```json
{
  "skill": "data-qa/Test-Data-Factory",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("data-qa/Test-Data-Factory", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("data-qa/Test-Data-Factory"),
...
```bash
# Clone the skill
skillshub clone data-qa/Test-Data-Factory
...
**Built with ❤️ by [data-qa](https://skillshub.dev/data-qa) on [SkillsHub](https://skillshub.dev)**
