...
**E-commerce Merchandiser** is a production-ready agent skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install merchfash/E-commerce-Merchandiser

# Or install via pip
pip install skillshub-e-commerce-merchandiser

# Or install via npm
npm install @skillshub/e-commerce-merchandiser
```
...
skill = load_skill("merchfash/E-commerce-Merchandiser")
...
```json
{
  "skill": "merchfash/E-commerce-Merchandiser",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("merchfash/E-commerce-Merchandiser", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("merchfash/E-commerce-Merchandiser"),
...
```bash
# Clone the skill
skillshub clone merchfash/E-commerce-Merchandiser
cd E-commerce-Merchandiser
...
**Built with ❤️ by [merchfash](https://skillshub.dev/merchfash) on [SkillsHub](https://skillshub.dev)**
