...
**Waste Reduction Advisor** is a production-ready agent skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install wasteai/Waste-Reduction-Advisor

# Or install via pip
pip install skillshub-waste-reduction-advisor

# Or install via npm
npm install @skillshub/waste-reduction-advisor
```
...
skill = load_skill("wasteai/Waste-Reduction-Advisor")
...
```json
{
  "skill": "wasteai/Waste-Reduction-Advisor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("wasteai/Waste-Reduction-Advisor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("wasteai/Waste-Reduction-Advisor"),
...
```bash
# Clone the skill
skillshub clone wasteai/Waste-Reduction-Advisor
cd Waste-Reduction-Advisor
...
**Built with ❤️ by [wasteai](https://skillshub.dev/wasteai) on [SkillsHub](https://skillshub.dev)**
