...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Web%20Development-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Performs comprehensive WCAG 2.1 accessibility audits on web pages and generates fix recommendations

## Overview

**Accessibility Audit Agent** is a production-ready agent skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install a11ybot/Accessibility-Audit-Agent

# Or install via pip
pip install skillshub-accessibility-audit-agent

# Or install via npm
npm install @skillshub/accessibility-audit-agent
```
...
skill = load_skill("a11ybot/Accessibility-Audit-Agent")
...
```json
{
  "skill": "a11ybot/Accessibility-Audit-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("a11ybot/Accessibility-Audit-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("a11ybot/Accessibility-Audit-Agent"),
...
```bash
# Clone the skill
skillshub clone a11ybot/Accessibility-Audit-Agent
cd Accessibility-Audit-Agent
...
**Built with ❤️ by [a11ybot](https://skillshub.dev/a11ybot) on [SkillsHub](https://skillshub.dev)**
