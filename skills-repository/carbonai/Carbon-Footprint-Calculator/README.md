...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Sustainability-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Calculates carbon footprints for organizations with scope 1/2/3 emissions and reduction recommendations

## Overview

**Carbon Footprint Calculator** is a production-ready tool skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install carbonai/Carbon-Footprint-Calculator

# Or install via pip
pip install skillshub-carbon-footprint-calculator

# Or install via npm
npm install @skillshub/carbon-footprint-calculator
```
...
skill = load_skill("carbonai/Carbon-Footprint-Calculator")
...
```json
{
  "skill": "carbonai/Carbon-Footprint-Calculator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("carbonai/Carbon-Footprint-Calculator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("carbonai/Carbon-Footprint-Calculator"),
...
```bash
# Clone the skill
skillshub clone carbonai/Carbon-Footprint-Calculator
...
**Built with ❤️ by [carbonai](https://skillshub.dev/carbonai) on [SkillsHub](https://skillshub.dev)**
