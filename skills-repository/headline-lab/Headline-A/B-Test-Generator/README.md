...
**Headline A/B Test Generator** is a production-ready prompt skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install headline-lab/Headline-A/B-Test-Generator

# Or add to your agent configuration
skillshub agent add-skill headline-lab/Headline-A/B-Test-Generator
```
...
skill = load_skill("headline-lab/Headline-A/B-Test-Generator")
...
```json
{
  "skill": "headline-lab/Headline-A/B-Test-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("headline-lab/Headline-A/B-Test-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("headline-lab/Headline-A/B-Test-Generator"),
...
```bash
# Clone the skill
skillshub clone headline-lab/Headline-A/B-Test-Generator
cd Headline-A/B-Test-Generator
...
**Built with ❤️ by [headline-lab](https://skillshub.dev/headline-lab) on [SkillsHub](https://skillshub.dev)**
