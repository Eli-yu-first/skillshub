...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Education%20%26%20Training-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes Individualized Education Program documents with goals, accommodations, and progress monitoring plans

## Overview

**IEP Document Writer** is a production-ready prompt skill designed for Education & Training workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install iepai/IEP-Document-Writer

# Or add to your agent configuration
skillshub agent add-skill iepai/IEP-Document-Writer
```
...
skill = load_skill("iepai/IEP-Document-Writer")
...
```json
{
  "skill": "iepai/IEP-Document-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("iepai/IEP-Document-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("iepai/IEP-Document-Writer"),
...
```bash
# Clone the skill
skillshub clone iepai/IEP-Document-Writer
cd IEP-Document-Writer
...
**Built with ❤️ by [iepai](https://skillshub.dev/iepai) on [SkillsHub](https://skillshub.dev)**
