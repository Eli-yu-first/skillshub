...
**Medical Billing Coder** is a production-ready agent skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install billingai/Medical-Billing-Coder

# Or install via pip
pip install skillshub-medical-billing-coder

# Or install via npm
npm install @skillshub/medical-billing-coder
```
...
skill = load_skill("billingai/Medical-Billing-Coder")
...
```json
{
  "skill": "billingai/Medical-Billing-Coder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("billingai/Medical-Billing-Coder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("billingai/Medical-Billing-Coder"),
...
```bash
# Clone the skill
skillshub clone billingai/Medical-Billing-Coder
cd Medical-Billing-Coder
...
**Built with ❤️ by [billingai](https://skillshub.dev/billingai) on [SkillsHub](https://skillshub.dev)**
