...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-API%20Development-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Generates OpenAPI 3.0 specifications from code or natural language API descriptions

## Overview

**OpenAPI Spec Generator** is a production-ready tool skill designed for API Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install openapibot/OpenAPI-Spec-Generator

# Or install via pip
pip install skillshub-openapi-spec-generator

# Or install via npm
npm install @skillshub/openapi-spec-generator
```
...
skill = load_skill("openapibot/OpenAPI-Spec-Generator")
...
```json
{
  "skill": "openapibot/OpenAPI-Spec-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("openapibot/OpenAPI-Spec-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("openapibot/OpenAPI-Spec-Generator"),
...
```bash
# Clone the skill
skillshub clone openapibot/OpenAPI-Spec-Generator
...
**Built with ❤️ by [openapibot](https://skillshub.dev/openapibot) on [SkillsHub](https://skillshub.dev)**
