...
> Formats citations and bibliographies in APA 7th, MLA 9th, Chicago, Harvard, and IEEE styles

## Overview

**Citation Formatter** is a production-ready tool skill designed for Academic Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install citeai/Citation-Formatter

# Or install via pip
pip install skillshub-citation-formatter

# Or install via npm
npm install @skillshub/citation-formatter
```
...
skill = load_skill("citeai/Citation-Formatter")
...
```json
{
  "skill": "citeai/Citation-Formatter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("citeai/Citation-Formatter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("citeai/Citation-Formatter"),
...
```bash
# Clone the skill
skillshub clone citeai/Citation-Formatter
...
**Built with ❤️ by [citeai](https://skillshub.dev/citeai) on [SkillsHub](https://skillshub.dev)**
