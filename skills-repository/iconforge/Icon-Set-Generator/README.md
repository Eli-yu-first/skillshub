...
> Creates consistent icon sets in multiple sizes and formats for web and mobile applications

## Overview

**Icon Set Generator** is a production-ready tool skill designed for Image Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install iconforge/Icon-Set-Generator

# Or install via pip
pip install skillshub-icon-set-generator

# Or install via npm
npm install @skillshub/icon-set-generator
```
...
skill = load_skill("iconforge/Icon-Set-Generator")
...
```json
{
  "skill": "iconforge/Icon-Set-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("iconforge/Icon-Set-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("iconforge/Icon-Set-Generator"),
...
```bash
# Clone the skill
skillshub clone iconforge/Icon-Set-Generator
cd Icon-Set-Generator
...
**Built with ❤️ by [iconforge](https://skillshub.dev/iconforge) on [SkillsHub](https://skillshub.dev)**
