...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Finance%20%26%20Accounting-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Forecasts cash flow with receivables/payables analysis, seasonal adjustments, and scenario modeling

## Overview

**Cash Flow Forecaster** is a production-ready agent skill designed for Finance & Accounting workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install cashflowai/Cash-Flow-Forecaster

# Or install via pip
pip install skillshub-cash-flow-forecaster

# Or install via npm
npm install @skillshub/cash-flow-forecaster
```
...
skill = load_skill("cashflowai/Cash-Flow-Forecaster")
...
```json
{
  "skill": "cashflowai/Cash-Flow-Forecaster",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("cashflowai/Cash-Flow-Forecaster", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("cashflowai/Cash-Flow-Forecaster"),
...
```bash
# Clone the skill
skillshub clone cashflowai/Cash-Flow-Forecaster
...
**Built with ❤️ by [cashflowai](https://skillshub.dev/cashflowai) on [SkillsHub](https://skillshub.dev)**
