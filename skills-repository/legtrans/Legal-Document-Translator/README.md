...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Legal%20Domain-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Translates legal documents while preserving legal terminology accuracy and jurisdictional nuances

## Overview

**Legal Document Translator** is a production-ready tool skill designed for Legal Domain workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install legtrans/Legal-Document-Translator
...
skill = load_skill("legtrans/Legal-Document-Translator")
...
```json
{
  "skill": "legtrans/Legal-Document-Translator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("legtrans/Legal-Document-Translator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("legtrans/Legal-Document-Translator"),
...
```bash
# Clone the skill
skillshub clone legtrans/Legal-Document-Translator
...
**Built with ❤️ by [legtrans](https://skillshub.dev/legtrans) on [SkillsHub](https://skillshub.dev)**
