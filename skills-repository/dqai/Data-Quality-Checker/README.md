...
**Data Quality Checker** is a production-ready tool skill designed for Data Science workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install dqai/Data-Quality-Checker

# Or install via pip
pip install skillshub-data-quality-checker

# Or install via npm
npm install @skillshub/data-quality-checker
```
...
skill = load_skill("dqai/Data-Quality-Checker")
...
```json
{
  "skill": "dqai/Data-Quality-Checker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("dqai/Data-Quality-Checker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("dqai/Data-Quality-Checker"),
...
```bash
# Clone the skill
skillshub clone dqai/Data-Quality-Checker
...
**Built with ❤️ by [dqai](https://skillshub.dev/dqai) on [SkillsHub](https://skillshub.dev)**
