...
**Video Script Writer** is a production-ready prompt skill designed for Video Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install scriptai/Video-Script-Writer

# Or add to your agent configuration
skillshub agent add-skill scriptai/Video-Script-Writer
```
...
skill = load_skill("scriptai/Video-Script-Writer")
...
```json
{
  "skill": "scriptai/Video-Script-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("scriptai/Video-Script-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("scriptai/Video-Script-Writer"),
...
```bash
# Clone the skill
skillshub clone scriptai/Video-Script-Writer
...
**Built with ❤️ by [scriptai](https://skillshub.dev/scriptai) on [SkillsHub](https://skillshub.dev)**
