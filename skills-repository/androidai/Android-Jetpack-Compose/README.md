...
**Android Jetpack Compose** is a production-ready prompt skill designed for App Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install androidai/Android-Jetpack-Compose

# Or add to your agent configuration
skillshub agent add-skill androidai/Android-Jetpack-Compose
```
...
skill = load_skill("androidai/Android-Jetpack-Compose")
...
```json
{
  "skill": "androidai/Android-Jetpack-Compose",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("androidai/Android-Jetpack-Compose", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("androidai/Android-Jetpack-Compose"),
...
```bash
# Clone the skill
skillshub clone androidai/Android-Jetpack-Compose
...
**Built with ❤️ by [androidai](https://skillshub.dev/androidai) on [SkillsHub](https://skillshub.dev)**
