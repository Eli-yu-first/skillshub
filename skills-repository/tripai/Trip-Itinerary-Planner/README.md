...
> Plans detailed trip itineraries with attractions, restaurants, transportation, and budget optimization

## Overview

**Trip Itinerary Planner** is a production-ready agent skill designed for Travel & Hospitality workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install tripai/Trip-Itinerary-Planner

# Or install via pip
pip install skillshub-trip-itinerary-planner

# Or install via npm
npm install @skillshub/trip-itinerary-planner
```
...
skill = load_skill("tripai/Trip-Itinerary-Planner")
...
```json
{
  "skill": "tripai/Trip-Itinerary-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("tripai/Trip-Itinerary-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("tripai/Trip-Itinerary-Planner"),
...
```bash
# Clone the skill
skillshub clone tripai/Trip-Itinerary-Planner
...
**Built with ❤️ by [tripai](https://skillshub.dev/tripai) on [SkillsHub](https://skillshub.dev)**
