...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Machine%20Learning-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Automates hyperparameter tuning with Bayesian optimization, grid search, and early stopping strategies

## Overview

**Hyperparameter Tuner** is a production-ready tool skill designed for Machine Learning workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install hptuneai/Hyperparameter-Tuner

# Or install via pip
pip install skillshub-hyperparameter-tuner

# Or install via npm
npm install @skillshub/hyperparameter-tuner
```
...
skill = load_skill("hptuneai/Hyperparameter-Tuner")
...
```json
{
  "skill": "hptuneai/Hyperparameter-Tuner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("hptuneai/Hyperparameter-Tuner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("hptuneai/Hyperparameter-Tuner"),
...
```bash
# Clone the skill
skillshub clone hptuneai/Hyperparameter-Tuner
...
**Built with ❤️ by [hptuneai](https://skillshub.dev/hptuneai) on [SkillsHub](https://skillshub.dev)**
