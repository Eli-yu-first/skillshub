...
**Named Entity Recognizer** is a production-ready tool skill designed for NLP workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install nerai/Named-Entity-Recognizer

# Or install via pip
pip install skillshub-named-entity-recognizer

# Or install via npm
npm install @skillshub/named-entity-recognizer
```
...
skill = load_skill("nerai/Named-Entity-Recognizer")
...
```json
{
  "skill": "nerai/Named-Entity-Recognizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("nerai/Named-Entity-Recognizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("nerai/Named-Entity-Recognizer"),
...
```bash
# Clone the skill
skillshub clone nerai/Named-Entity-Recognizer
cd Named-Entity-Recognizer
...
**Built with ❤️ by [nerai](https://skillshub.dev/nerai) on [SkillsHub](https://skillshub.dev)**
