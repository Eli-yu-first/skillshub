...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Web%20Development-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Converts traditional CSS stylesheets to Tailwind CSS utility classes with responsive breakpoints

## Overview

**CSS-to-Tailwind Converter** is a production-ready tool skill designed for Web Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install stylebot/CSS-to-Tailwind-Converter

# Or install via pip
pip install skillshub-css-to-tailwind-converter

# Or install via npm
npm install @skillshub/css-to-tailwind-converter
```
...
skill = load_skill("stylebot/CSS-to-Tailwind-Converter")
...
```json
{
  "skill": "stylebot/CSS-to-Tailwind-Converter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("stylebot/CSS-to-Tailwind-Converter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("stylebot/CSS-to-Tailwind-Converter"),
...
```bash
# Clone the skill
skillshub clone stylebot/CSS-to-Tailwind-Converter
...
**Built with ❤️ by [stylebot](https://skillshub.dev/stylebot) on [SkillsHub](https://skillshub.dev)**
