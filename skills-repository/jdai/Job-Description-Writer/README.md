...
**Job Description Writer** is a production-ready prompt skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install jdai/Job-Description-Writer

# Or add to your agent configuration
skillshub agent add-skill jdai/Job-Description-Writer
```
...
skill = load_skill("jdai/Job-Description-Writer")
...
```json
{
  "skill": "jdai/Job-Description-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("jdai/Job-Description-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("jdai/Job-Description-Writer"),
...
```bash
# Clone the skill
skillshub clone jdai/Job-Description-Writer
cd Job-Description-Writer
...
**Built with ❤️ by [jdai](https://skillshub.dev/jdai) on [SkillsHub](https://skillshub.dev)**
