...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Supply%20Chain%20%26%20Logistics-coral) ![Type](https://img.shields.io/badge/type-agent-teal)

> Optimize last-mile delivery with dynamic routing, time slot management, and driver allocation

## Overview

**Last Mile Delivery Optimizer** is a production-ready agent skill designed for Supply Chain & Logistics workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install lastmile-ai/Last-Mile-Delivery-Optimizer

# Or install via pip
pip install skillshub-last-mile-delivery-optimizer

# Or install via npm
npm install @skillshub/last-mile-delivery-optimizer
```
...
skill = load_skill("lastmile-ai/Last-Mile-Delivery-Optimizer")
...
```json
{
  "skill": "lastmile-ai/Last-Mile-Delivery-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("lastmile-ai/Last-Mile-Delivery-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("lastmile-ai/Last-Mile-Delivery-Optimizer"),
...
```bash
# Clone the skill
skillshub clone lastmile-ai/Last-Mile-Delivery-Optimizer
...
**Built with ❤️ by [lastmile-ai](https://skillshub.dev/lastmile-ai) on [SkillsHub](https://skillshub.dev)**
