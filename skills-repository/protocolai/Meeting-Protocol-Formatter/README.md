...
**Meeting Protocol Formatter** is a production-ready tool skill designed for Official Document Writing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install protocolai/Meeting-Protocol-Formatter

# Or install via pip
pip install skillshub-meeting-protocol-formatter

# Or install via npm
npm install @skillshub/meeting-protocol-formatter
```
...
skill = load_skill("protocolai/Meeting-Protocol-Formatter")
...
```json
{
  "skill": "protocolai/Meeting-Protocol-Formatter",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("protocolai/Meeting-Protocol-Formatter", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("protocolai/Meeting-Protocol-Formatter"),
...
```bash
# Clone the skill
skillshub clone protocolai/Meeting-Protocol-Formatter
cd Meeting-Protocol-Formatter
...
**Built with ❤️ by [protocolai](https://skillshub.dev/protocolai) on [SkillsHub](https://skillshub.dev)**
