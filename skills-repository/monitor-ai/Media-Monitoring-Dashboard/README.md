...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Journalism%20%26%20Media-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Track media mentions, sentiment analysis, and competitive coverage across news outlets

## Overview

**Media Monitoring Dashboard** is a production-ready workflow skill designed for Journalism & Media workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install monitor-ai/Media-Monitoring-Dashboard

# Or install via pip
pip install skillshub-media-monitoring-dashboard

# Or install via npm
npm install @skillshub/media-monitoring-dashboard
```
...
skill = load_skill("monitor-ai/Media-Monitoring-Dashboard")
...
```json
{
  "skill": "monitor-ai/Media-Monitoring-Dashboard",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("monitor-ai/Media-Monitoring-Dashboard", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("monitor-ai/Media-Monitoring-Dashboard"),
...
```bash
# Clone the skill
skillshub clone monitor-ai/Media-Monitoring-Dashboard
...
**Built with ❤️ by [monitor-ai](https://skillshub.dev/monitor-ai) on [SkillsHub](https://skillshub.dev)**
