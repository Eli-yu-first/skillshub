...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Content%20Creation-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Generate detailed podcast show notes with timestamps, key takeaways, and resource links

## Overview

**Podcast Show Notes Generator** is a production-ready prompt skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install pod-tools/Podcast-Show-Notes-Generator

# Or add to your agent configuration
skillshub agent add-skill pod-tools/Podcast-Show-Notes-Generator
```
...
skill = load_skill("pod-tools/Podcast-Show-Notes-Generator")
...
```json
{
  "skill": "pod-tools/Podcast-Show-Notes-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("pod-tools/Podcast-Show-Notes-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("pod-tools/Podcast-Show-Notes-Generator"),
...
```bash
# Clone the skill
skillshub clone pod-tools/Podcast-Show-Notes-Generator
...
**Built with ❤️ by [pod-tools](https://skillshub.dev/pod-tools) on [SkillsHub](https://skillshub.dev)**
