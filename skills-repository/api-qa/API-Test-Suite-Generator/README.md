...
**API Test Suite Generator** is a production-ready tool skill designed for Quality Assurance workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install api-qa/API-Test-Suite-Generator

# Or install via pip
pip install skillshub-api-test-suite-generator

# Or install via npm
npm install @skillshub/api-test-suite-generator
```
...
skill = load_skill("api-qa/API-Test-Suite-Generator")
...
```json
{
  "skill": "api-qa/API-Test-Suite-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("api-qa/API-Test-Suite-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("api-qa/API-Test-Suite-Generator"),
...
```bash
# Clone the skill
skillshub clone api-qa/API-Test-Suite-Generator
...
**Built with ❤️ by [api-qa](https://skillshub.dev/api-qa) on [SkillsHub](https://skillshub.dev)**
