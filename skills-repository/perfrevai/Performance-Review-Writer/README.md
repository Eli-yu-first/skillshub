...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Human%20Resources-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Writes constructive performance reviews with specific examples, goal alignment, and development plans

## Overview

**Performance Review Writer** is a production-ready prompt skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install perfrevai/Performance-Review-Writer

# Or add to your agent configuration
skillshub agent add-skill perfrevai/Performance-Review-Writer
```
...
skill = load_skill("perfrevai/Performance-Review-Writer")
...
```json
{
  "skill": "perfrevai/Performance-Review-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("perfrevai/Performance-Review-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("perfrevai/Performance-Review-Writer"),
...
```bash
# Clone the skill
skillshub clone perfrevai/Performance-Review-Writer
cd Performance-Review-Writer
...
**Built with ❤️ by [perfrevai](https://skillshub.dev/perfrevai) on [SkillsHub](https://skillshub.dev)**
