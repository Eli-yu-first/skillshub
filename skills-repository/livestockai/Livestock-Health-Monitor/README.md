...
**Livestock Health Monitor** is a production-ready agent skill designed for Agriculture workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install livestockai/Livestock-Health-Monitor

# Or install via pip
pip install skillshub-livestock-health-monitor

# Or install via npm
npm install @skillshub/livestock-health-monitor
```
...
skill = load_skill("livestockai/Livestock-Health-Monitor")
...
```json
{
  "skill": "livestockai/Livestock-Health-Monitor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("livestockai/Livestock-Health-Monitor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("livestockai/Livestock-Health-Monitor"),
...
```bash
# Clone the skill
skillshub clone livestockai/Livestock-Health-Monitor
...
**Built with ❤️ by [livestockai](https://skillshub.dev/livestockai) on [SkillsHub](https://skillshub.dev)**
