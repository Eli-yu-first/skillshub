...
> Build optimized morning routines based on goals, chronotype, and available time

## Overview

**Morning Routine Builder** is a production-ready prompt skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install routine-ai/Morning-Routine-Builder

# Or add to your agent configuration
skillshub agent add-skill routine-ai/Morning-Routine-Builder
```
...
skill = load_skill("routine-ai/Morning-Routine-Builder")
...
```json
{
  "skill": "routine-ai/Morning-Routine-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("routine-ai/Morning-Routine-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("routine-ai/Morning-Routine-Builder"),
...
```bash
# Clone the skill
skillshub clone routine-ai/Morning-Routine-Builder
cd Morning-Routine-Builder
...
**Built with ❤️ by [routine-ai](https://skillshub.dev/routine-ai) on [SkillsHub](https://skillshub.dev)**
