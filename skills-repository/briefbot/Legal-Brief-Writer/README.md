...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Legal%20Domain-coral) ![Type](https://img.shields.io/badge/type-prompt-purple)

> Drafts legal briefs with case law citations, argument structure, and jurisdictional considerations

## Overview

**Legal Brief Writer** is a production-ready prompt skill designed for Legal Domain workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install briefbot/Legal-Brief-Writer

# Or add to your agent configuration
skillshub agent add-skill briefbot/Legal-Brief-Writer
```
...
skill = load_skill("briefbot/Legal-Brief-Writer")
...
```json
{
  "skill": "briefbot/Legal-Brief-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("briefbot/Legal-Brief-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("briefbot/Legal-Brief-Writer"),
...
```bash
# Clone the skill
skillshub clone briefbot/Legal-Brief-Writer
cd Legal-Brief-Writer
...
**Built with ❤️ by [briefbot](https://skillshub.dev/briefbot) on [SkillsHub](https://skillshub.dev)**
