...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Fitness%20%26%20Sports-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Calculates macro nutrition targets with meal planning, calorie tracking, and dietary restriction support

## Overview

**Nutrition Macro Calculator** is a production-ready tool skill designed for Fitness & Sports workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install macroai/Nutrition-Macro-Calculator

# Or install via pip
pip install skillshub-nutrition-macro-calculator

# Or install via npm
npm install @skillshub/nutrition-macro-calculator
```
...
skill = load_skill("macroai/Nutrition-Macro-Calculator")
...
```json
{
  "skill": "macroai/Nutrition-Macro-Calculator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("macroai/Nutrition-Macro-Calculator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("macroai/Nutrition-Macro-Calculator"),
...
```bash
# Clone the skill
skillshub clone macroai/Nutrition-Macro-Calculator
cd Nutrition-Macro-Calculator
...
**Built with ❤️ by [macroai](https://skillshub.dev/macroai) on [SkillsHub](https://skillshub.dev)**
