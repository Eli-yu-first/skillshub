...
**Book Summary Generator** is a production-ready prompt skill designed for Personal Development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install read-ai/Book-Summary-Generator

# Or add to your agent configuration
skillshub agent add-skill read-ai/Book-Summary-Generator
```
...
skill = load_skill("read-ai/Book-Summary-Generator")
...
```json
{
  "skill": "read-ai/Book-Summary-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("read-ai/Book-Summary-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("read-ai/Book-Summary-Generator"),
...
```bash
# Clone the skill
skillshub clone read-ai/Book-Summary-Generator
...
**Built with ❤️ by [read-ai](https://skillshub.dev/read-ai) on [SkillsHub](https://skillshub.dev)**
