...
**PowerPoint Slide Designer** is a production-ready agent skill designed for Office Productivity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install slideai/PowerPoint-Slide-Designer

# Or install via pip
pip install skillshub-powerpoint-slide-designer

# Or install via npm
npm install @skillshub/powerpoint-slide-designer
```
...
skill = load_skill("slideai/PowerPoint-Slide-Designer")
...
```json
{
  "skill": "slideai/PowerPoint-Slide-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("slideai/PowerPoint-Slide-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("slideai/PowerPoint-Slide-Designer"),
...
```bash
# Clone the skill
skillshub clone slideai/PowerPoint-Slide-Designer
cd PowerPoint-Slide-Designer
...
**Built with ❤️ by [slideai](https://skillshub.dev/slideai) on [SkillsHub](https://skillshub.dev)**
