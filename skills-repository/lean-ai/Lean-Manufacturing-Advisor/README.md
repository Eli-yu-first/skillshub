...
> Identify waste, suggest kaizen improvements, and implement lean manufacturing principles

## Overview

**Lean Manufacturing Advisor** is a production-ready agent skill designed for Manufacturing workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install lean-ai/Lean-Manufacturing-Advisor

# Or install via pip
pip install skillshub-lean-manufacturing-advisor

# Or install via npm
npm install @skillshub/lean-manufacturing-advisor
```
...
skill = load_skill("lean-ai/Lean-Manufacturing-Advisor")
...
```json
{
  "skill": "lean-ai/Lean-Manufacturing-Advisor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("lean-ai/Lean-Manufacturing-Advisor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("lean-ai/Lean-Manufacturing-Advisor"),
...
```bash
# Clone the skill
skillshub clone lean-ai/Lean-Manufacturing-Advisor
cd Lean-Manufacturing-Advisor
...
**Built with ❤️ by [lean-ai](https://skillshub.dev/lean-ai) on [SkillsHub](https://skillshub.dev)**
