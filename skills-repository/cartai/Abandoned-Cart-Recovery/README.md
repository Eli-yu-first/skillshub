...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-E-commerce-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Creates abandoned cart recovery email sequences with personalization, urgency triggers, and discount strategies

## Overview

**Abandoned Cart Recovery** is a production-ready workflow skill designed for E-commerce workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install cartai/Abandoned-Cart-Recovery

# Or install via pip
pip install skillshub-abandoned-cart-recovery

# Or install via npm
npm install @skillshub/abandoned-cart-recovery
```
...
skill = load_skill("cartai/Abandoned-Cart-Recovery")
...
```json
{
  "skill": "cartai/Abandoned-Cart-Recovery",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("cartai/Abandoned-Cart-Recovery", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("cartai/Abandoned-Cart-Recovery"),
...
```bash
# Clone the skill
skillshub clone cartai/Abandoned-Cart-Recovery
...
**Built with ❤️ by [cartai](https://skillshub.dev/cartai) on [SkillsHub](https://skillshub.dev)**
