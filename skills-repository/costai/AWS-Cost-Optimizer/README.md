...
**AWS Cost Optimizer** is a production-ready agent skill designed for DevOps & Cloud workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install costai/AWS-Cost-Optimizer

# Or install via pip
pip install skillshub-aws-cost-optimizer

# Or install via npm
npm install @skillshub/aws-cost-optimizer
```
...
skill = load_skill("costai/AWS-Cost-Optimizer")
...
```json
{
  "skill": "costai/AWS-Cost-Optimizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("costai/AWS-Cost-Optimizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("costai/AWS-Cost-Optimizer"),
...
```bash
# Clone the skill
skillshub clone costai/AWS-Cost-Optimizer
...
**Built with ❤️ by [costai](https://skillshub.dev/costai) on [SkillsHub](https://skillshub.dev)**
