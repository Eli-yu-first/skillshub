...
**Music Distribution Planner** is a production-ready workflow skill designed for Music Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install distroai/Music-Distribution-Planner

# Or install via pip
pip install skillshub-music-distribution-planner

# Or install via npm
npm install @skillshub/music-distribution-planner
```
...
skill = load_skill("distroai/Music-Distribution-Planner")
...
```json
{
  "skill": "distroai/Music-Distribution-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("distroai/Music-Distribution-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("distroai/Music-Distribution-Planner"),
...
```bash
# Clone the skill
skillshub clone distroai/Music-Distribution-Planner
cd Music-Distribution-Planner
...
**Built with ❤️ by [distroai](https://skillshub.dev/distroai) on [SkillsHub](https://skillshub.dev)**
