...
**DeFi Protocol Builder** is a production-ready workflow skill designed for Blockchain & Web3 workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install defiai/DeFi-Protocol-Builder

# Or install via pip
pip install skillshub-defi-protocol-builder

# Or install via npm
npm install @skillshub/defi-protocol-builder
```
...
skill = load_skill("defiai/DeFi-Protocol-Builder")
...
```json
{
  "skill": "defiai/DeFi-Protocol-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("defiai/DeFi-Protocol-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("defiai/DeFi-Protocol-Builder"),
...
```bash
# Clone the skill
skillshub clone defiai/DeFi-Protocol-Builder
cd DeFi-Protocol-Builder
...
**Built with ❤️ by [defiai](https://skillshub.dev/defiai) on [SkillsHub](https://skillshub.dev)**
