...
**Product Description Writer** is a production-ready prompt skill designed for Content Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install ecom-content/Product-Description-Writer

# Or add to your agent configuration
skillshub agent add-skill ecom-content/Product-Description-Writer
```
...
skill = load_skill("ecom-content/Product-Description-Writer")
...
```json
{
  "skill": "ecom-content/Product-Description-Writer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("ecom-content/Product-Description-Writer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("ecom-content/Product-Description-Writer"),
...
```bash
# Clone the skill
skillshub clone ecom-content/Product-Description-Writer
...
**Built with ❤️ by [ecom-content](https://skillshub.dev/ecom-content) on [SkillsHub](https://skillshub.dev)**
