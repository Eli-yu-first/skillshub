...
**Telemedicine Script Generator** is a production-ready prompt skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install telehealth-pro/Telemedicine-Script-Generator

# Or add to your agent configuration
skillshub agent add-skill telehealth-pro/Telemedicine-Script-Generator
```
...
skill = load_skill("telehealth-pro/Telemedicine-Script-Generator")
...
```json
{
  "skill": "telehealth-pro/Telemedicine-Script-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("telehealth-pro/Telemedicine-Script-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("telehealth-pro/Telemedicine-Script-Generator"),
...
```bash
# Clone the skill
skillshub clone telehealth-pro/Telemedicine-Script-Generator
cd Telemedicine-Script-Generator
...
**Built with ❤️ by [telehealth-pro](https://skillshub.dev/telehealth-pro) on [SkillsHub](https://skillshub.dev)**
