...
**Banner Ad Designer** is a production-ready agent skill designed for Image Creation workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install adcraft/Banner-Ad-Designer

# Or install via pip
pip install skillshub-banner-ad-designer

# Or install via npm
npm install @skillshub/banner-ad-designer
```
...
skill = load_skill("adcraft/Banner-Ad-Designer")
...
```json
{
  "skill": "adcraft/Banner-Ad-Designer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("adcraft/Banner-Ad-Designer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("adcraft/Banner-Ad-Designer"),
...
```bash
# Clone the skill
skillshub clone adcraft/Banner-Ad-Designer
cd Banner-Ad-Designer
...
**Built with ❤️ by [adcraft](https://skillshub.dev/adcraft) on [SkillsHub](https://skillshub.dev)**
