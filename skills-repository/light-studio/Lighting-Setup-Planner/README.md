...
**Lighting Setup Planner** is a production-ready workflow skill designed for Photography workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install light-studio/Lighting-Setup-Planner

# Or install via pip
pip install skillshub-lighting-setup-planner

# Or install via npm
npm install @skillshub/lighting-setup-planner
```
...
skill = load_skill("light-studio/Lighting-Setup-Planner")
...
```json
{
  "skill": "light-studio/Lighting-Setup-Planner",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("light-studio/Lighting-Setup-Planner", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("light-studio/Lighting-Setup-Planner"),
...
```bash
# Clone the skill
skillshub clone light-studio/Lighting-Setup-Planner
cd Lighting-Setup-Planner
...
**Built with ❤️ by [light-studio](https://skillshub.dev/light-studio) on [SkillsHub](https://skillshub.dev)**
