...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Fashion%20%26%20Textile-coral) ![Type](https://img.shields.io/badge/type-workflow-teal)

> Tracks fashion supply chains with material sourcing, production timelines, and sustainability scoring

## Overview

**Supply Chain Tracker** is a production-ready workflow skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install supplyai/Supply-Chain-Tracker

# Or install via pip
pip install skillshub-supply-chain-tracker

# Or install via npm
npm install @skillshub/supply-chain-tracker
```
...
skill = load_skill("supplyai/Supply-Chain-Tracker")
...
```json
{
  "skill": "supplyai/Supply-Chain-Tracker",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("supplyai/Supply-Chain-Tracker", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("supplyai/Supply-Chain-Tracker"),
...
```bash
# Clone the skill
skillshub clone supplyai/Supply-Chain-Tracker
...
**Built with ❤️ by [supplyai](https://skillshub.dev/supplyai) on [SkillsHub](https://skillshub.dev)**
