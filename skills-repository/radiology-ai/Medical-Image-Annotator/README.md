...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Healthcare%20%26%20Medical-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Assist radiologists by highlighting regions of interest in medical imaging scans

## Overview

**Medical Image Annotator** is a production-ready tool skill designed for Healthcare & Medical workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install radiology-ai/Medical-Image-Annotator

# Or install via pip
pip install skillshub-medical-image-annotator

# Or install via npm
npm install @skillshub/medical-image-annotator
```
...
skill = load_skill("radiology-ai/Medical-Image-Annotator")
...
```json
{
  "skill": "radiology-ai/Medical-Image-Annotator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("radiology-ai/Medical-Image-Annotator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("radiology-ai/Medical-Image-Annotator"),
...
```bash
# Clone the skill
skillshub clone radiology-ai/Medical-Image-Annotator
cd Medical-Image-Annotator
...
**Built with ❤️ by [radiology-ai](https://skillshub.dev/radiology-ai) on [SkillsHub](https://skillshub.dev)**
