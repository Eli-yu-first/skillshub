...
> Transcribes meeting recordings and generates structured minutes with action items and decisions

## Overview

**Meeting Minutes Generator** is a production-ready agent skill designed for Office Productivity workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install meetbot/Meeting-Minutes-Generator

# Or install via pip
pip install skillshub-meeting-minutes-generator

# Or install via npm
npm install @skillshub/meeting-minutes-generator
```
...
skill = load_skill("meetbot/Meeting-Minutes-Generator")
...
```json
{
  "skill": "meetbot/Meeting-Minutes-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("meetbot/Meeting-Minutes-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("meetbot/Meeting-Minutes-Generator"),
...
```bash
# Clone the skill
skillshub clone meetbot/Meeting-Minutes-Generator
...
**Built with ❤️ by [meetbot](https://skillshub.dev/meetbot) on [SkillsHub](https://skillshub.dev)**
