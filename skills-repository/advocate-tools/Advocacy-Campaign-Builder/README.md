...
**Advocacy Campaign Builder** is a production-ready workflow skill designed for Non-profit & Social Impact workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install advocate-tools/Advocacy-Campaign-Builder

# Or install via pip
pip install skillshub-advocacy-campaign-builder

# Or install via npm
npm install @skillshub/advocacy-campaign-builder
```
...
skill = load_skill("advocate-tools/Advocacy-Campaign-Builder")
...
```json
{
  "skill": "advocate-tools/Advocacy-Campaign-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("advocate-tools/Advocacy-Campaign-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("advocate-tools/Advocacy-Campaign-Builder"),
...
```bash
# Clone the skill
skillshub clone advocate-tools/Advocacy-Campaign-Builder
cd Advocacy-Campaign-Builder
...
**Built with ❤️ by [advocate-tools](https://skillshub.dev/advocate-tools) on [SkillsHub](https://skillshub.dev)**
