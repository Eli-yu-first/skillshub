...
**UX Writing Assistant** is a production-ready prompt skill designed for UI/UX Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install uxwrite/UX-Writing-Assistant

# Or add to your agent configuration
skillshub agent add-skill uxwrite/UX-Writing-Assistant
```
...
skill = load_skill("uxwrite/UX-Writing-Assistant")
...
```json
{
  "skill": "uxwrite/UX-Writing-Assistant",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("uxwrite/UX-Writing-Assistant", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("uxwrite/UX-Writing-Assistant"),
...
```bash
# Clone the skill
skillshub clone uxwrite/UX-Writing-Assistant
cd UX-Writing-Assistant
...
**Built with ❤️ by [uxwrite](https://skillshub.dev/uxwrite) on [SkillsHub](https://skillshub.dev)**
