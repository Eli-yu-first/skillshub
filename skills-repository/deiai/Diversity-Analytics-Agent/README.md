...
**Diversity Analytics Agent** is a production-ready agent skill designed for Human Resources workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install deiai/Diversity-Analytics-Agent

# Or install via pip
pip install skillshub-diversity-analytics-agent

# Or install via npm
npm install @skillshub/diversity-analytics-agent
```
...
skill = load_skill("deiai/Diversity-Analytics-Agent")
...
```json
{
  "skill": "deiai/Diversity-Analytics-Agent",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("deiai/Diversity-Analytics-Agent", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("deiai/Diversity-Analytics-Agent"),
...
```bash
# Clone the skill
skillshub clone deiai/Diversity-Analytics-Agent
cd Diversity-Analytics-Agent
...
**Built with ❤️ by [deiai](https://skillshub.dev/deiai) on [SkillsHub](https://skillshub.dev)**
