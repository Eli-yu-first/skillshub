...
**Biodiversity Impact Assessor** is a production-ready agent skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install bioai/Biodiversity-Impact-Assessor

# Or install via pip
pip install skillshub-biodiversity-impact-assessor

# Or install via npm
npm install @skillshub/biodiversity-impact-assessor
```
...
skill = load_skill("bioai/Biodiversity-Impact-Assessor")
...
```json
{
  "skill": "bioai/Biodiversity-Impact-Assessor",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("bioai/Biodiversity-Impact-Assessor", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("bioai/Biodiversity-Impact-Assessor"),
...
```bash
# Clone the skill
skillshub clone bioai/Biodiversity-Impact-Assessor
cd Biodiversity-Impact-Assessor
...
**Built with ❤️ by [bioai](https://skillshub.dev/bioai) on [SkillsHub](https://skillshub.dev)**
