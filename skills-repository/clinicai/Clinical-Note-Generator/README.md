...
**Clinical Note Generator** is a production-ready prompt skill designed for AI development workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install clinicai/Clinical-Note-Generator

# Or add to your agent configuration
skillshub agent add-skill clinicai/Clinical-Note-Generator
```
...
skill = load_skill("clinicai/Clinical-Note-Generator")
...
```json
{
  "skill": "clinicai/Clinical-Note-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("clinicai/Clinical-Note-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("clinicai/Clinical-Note-Generator"),
...
```bash
# Clone the skill
skillshub clone clinicai/Clinical-Note-Generator
...
**Built with ❤️ by [clinicai](https://skillshub.dev/clinicai) on [SkillsHub](https://skillshub.dev)**
