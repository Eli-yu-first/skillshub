...
![Version](https://img.shields.io/badge/version-1.0.0-blue) ![License](https://img.shields.io/badge/license-MIT-green) ![Skills](https://img.shields.io/badge/SkillsHub-Fashion%20%26%20Textile-coral) ![Type](https://img.shields.io/badge/type-tool-teal)

> Creates size charts with measurement conversions, fit recommendations, and international sizing standards

## Overview

**Size Chart Builder** is a production-ready tool skill designed for Fashion & Textile workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sizechart/Size-Chart-Builder

# Or install via pip
pip install skillshub-size-chart-builder

# Or install via npm
npm install @skillshub/size-chart-builder
```
...
skill = load_skill("sizechart/Size-Chart-Builder")
...
```json
{
  "skill": "sizechart/Size-Chart-Builder",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sizechart/Size-Chart-Builder", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sizechart/Size-Chart-Builder"),
...
```bash
# Clone the skill
skillshub clone sizechart/Size-Chart-Builder
cd Size-Chart-Builder
...
**Built with ❤️ by [sizechart](https://skillshub.dev/sizechart) on [SkillsHub](https://skillshub.dev)**
