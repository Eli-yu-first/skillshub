...
> Organizes sample libraries with auto-tagging, BPM detection, key analysis, and similarity grouping

## Overview

**Sample Library Organizer** is a production-ready tool skill designed for Music Production workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install sampleai/Sample-Library-Organizer

# Or install via pip
pip install skillshub-sample-library-organizer

# Or install via npm
npm install @skillshub/sample-library-organizer
```
...
skill = load_skill("sampleai/Sample-Library-Organizer")
...
```json
{
  "skill": "sampleai/Sample-Library-Organizer",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("sampleai/Sample-Library-Organizer", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("sampleai/Sample-Library-Organizer"),
...
```bash
# Clone the skill
skillshub clone sampleai/Sample-Library-Organizer
...
**Built with ❤️ by [sampleai](https://skillshub.dev/sampleai) on [SkillsHub](https://skillshub.dev)**
