...
**Floor Plan Generator** is a production-ready tool skill designed for Architecture & Interior Design workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install floorplanai/Floor-Plan-Generator

# Or install via pip
pip install skillshub-floor-plan-generator

# Or install via npm
npm install @skillshub/floor-plan-generator
```
...
skill = load_skill("floorplanai/Floor-Plan-Generator")
...
```json
{
  "skill": "floorplanai/Floor-Plan-Generator",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("floorplanai/Floor-Plan-Generator", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("floorplanai/Floor-Plan-Generator"),
...
```bash
# Clone the skill
skillshub clone floorplanai/Floor-Plan-Generator
...
**Built with ❤️ by [floorplanai](https://skillshub.dev/floorplanai) on [SkillsHub](https://skillshub.dev)**
