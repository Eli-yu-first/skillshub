...
**Sustainability KPI Dashboard** is a production-ready workflow skill designed for Sustainability workflows. Built with industry best practices, it provides reliable, efficient, and scalable capabilities for modern AI applications.
...
skillshub install kpisustain/Sustainability-KPI-Dashboard

# Or install via pip
pip install skillshub-sustainability-kpi-dashboard

# Or install via npm
npm install @skillshub/sustainability-kpi-dashboard
```
...
skill = load_skill("kpisustain/Sustainability-KPI-Dashboard")
...
```json
{
  "skill": "kpisustain/Sustainability-KPI-Dashboard",
  "version": "1.0.0",
  "model": {
    "provider": "openai",
    "name": "gpt-4o",
...
skill = load_skill("kpisustain/Sustainability-KPI-Dashboard", config=config)
...
agent = Agent(
    name="My Agent",
    skills=[
        load_skill("kpisustain/Sustainability-KPI-Dashboard"),
...
```bash
# Clone the skill
skillshub clone kpisustain/Sustainability-KPI-Dashboard
cd Sustainability-KPI-Dashboard
...
**Built with ❤️ by [kpisustain](https://skillshub.dev/kpisustain) on [SkillsHub](https://skillshub.dev)**
